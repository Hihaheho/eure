...
pub trait GrammarTrait<'t> {
    ...
    fn top_level_binding(&mut self, _arg: &TopLevelBinding<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn root_value_binding(&mut self, _arg: &RootValueBinding<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'RootTextBinding'
    fn root_text_binding(&mut self, _arg: &RootTextBinding<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn flat_body(&mut self, _arg: &FlatBody<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'SectionHead'
    fn section_head(&mut self, _arg: &SectionHead<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'NewlineHead'
    fn newline_head(&mut self, _arg: &NewlineHead<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'FlatRootBinding'
    fn flat_root_binding(&mut self, _arg: &FlatRootBinding<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'BlockBody'
    fn block_body(&mut self, _arg: &BlockBody<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn first_key(&mut self, _arg: &FirstKey<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'KeyTail'
    fn key_tail(&mut self, _arg: &KeyTail<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DotKey'
    fn dot_key(&mut self, _arg: &DotKey<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn inf(&mut self, _arg: &Inf<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'NaN'
    fn na_n(&mut self, _arg: &NaN<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn lit_str(&mut self, _arg: &LitStr<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn lit_str2(&mut self, _arg: &LitStr2<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'LitStr3'
    fn lit_str3(&mut self, _arg: &LitStr3<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCode'
    fn delim_code(&mut self, _arg: &DelimCode<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCode1'
    fn delim_code1(&mut self, _arg: &DelimCode1<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCode2'
    fn delim_code2(&mut self, _arg: &DelimCode2<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCode3'
    fn delim_code3(&mut self, _arg: &DelimCode3<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn lit_str3_start(&mut self, _arg: &LitStr3Start<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'LitStr2Start'
    fn lit_str2_start(&mut self, _arg: &LitStr2Start<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'LitStr1Start'
    fn lit_str1_start(&mut self, _arg: &LitStr1Start<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCodeStart3'
    fn delim_code_start3(&mut self, _arg: &DelimCodeStart3<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCodeStart2'
    fn delim_code_start2(&mut self, _arg: &DelimCodeStart2<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCodeStart1'
    fn delim_code_start1(&mut self, _arg: &DelimCodeStart1<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn lit_str3_end(&mut self, _arg: &LitStr3End<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'LitStr2End'
    fn lit_str2_end(&mut self, _arg: &LitStr2End<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'LitStr1End'
    fn lit_str1_end(&mut self, _arg: &LitStr1End<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn no_s_quote(&mut self, _arg: &NoSQuote<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCodeEnd3'
    fn delim_code_end3(&mut self, _arg: &DelimCodeEnd3<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCodeEnd2'
    fn delim_code_end2(&mut self, _arg: &DelimCodeEnd2<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'DelimCodeEnd1'
    fn delim_code_end1(&mut self, _arg: &DelimCodeEnd1<'t>) -> Result<()> {
        Ok(())
    }
    ...
    /// Semantic action for non-terminal 'Caret'
    fn caret(&mut self, _arg: &Caret<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn newline_bind(&mut self, _arg: &NewlineBind<'t>) -> Result<()> {
        Ok(())
    }
    ...
    fn newline_text_start(&mut self, _arg: &NewlineTextStart<'t>) -> Result<()> {
        Ok(())
    }
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct TopLevelBindingValueBinding<'t> {
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct TopLevelBindingTextBinding<'t> {
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct SectionBodySectionBodyOpt<'t> {
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct SectionHeadRootBinding<'t> {
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct FlatRootBindingValueBinding<'t> {
    pub value_binding: ValueBinding<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct FlatRootBindingTextBinding<'t> {
    pub text_binding: TextBinding<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct FirstKeyArrayMarker<'t> {
...
///
/// `ArrayMarkerOptGroup: Integer;`
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct ArrayMarkerOptGroupInteger<'t> {
    pub integer: Integer<'t>,
}

impl ToSpan for ArrayMarkerOptGroupInteger<'_> {
    fn span(&self) -> Span {
        self.integer.span()
    }
}
...
///
/// `ArrayMarkerOptGroup: Caret;`
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct ArrayMarkerOptGroupCaret<'t> {
    pub caret: Caret<'t>,
}

impl ToSpan for ArrayMarkerOptGroupCaret<'_> {
    fn span(&self) -> Span {
        self.caret.span()
    }
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct KeyExtensionNameSpace<'t> {
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct LitStr2ListGroupNoSQuote<'t> {
    pub no_s_quote: NoSQuote<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct LitStr3ListGroupNoSQuote<'t> {
    pub no_s_quote: NoSQuote<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct DelimCode1ListGroupNoBacktick<'t> {
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct DelimCode2ListGroupNoBacktick<'t> {
    pub no_backtick: NoBacktick<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct DelimCode3ListGroupNoBacktick<'t> {
    pub no_backtick: NoBacktick<'t>,
}
...
pub struct ArrayMarkerOpt<'t> {
    pub array_marker_opt_group: ArrayMarkerOptGroup<'t>,
}

impl ToSpan for ArrayMarkerOpt<'_> {
    fn span(&self) -> Span {
        self.array_marker_opt_group.span()
    }
}
...
impl ToSpan for ArrayMarkerOptGroup<'_> {
    fn span(&self) -> Span {
        match self {
            ArrayMarkerOptGroup::Integer(v) => v.span(),
            ArrayMarkerOptGroup::Caret(v) => v.span(),
        }
    }
}
...
///
/// Type derived for non-terminal Caret
///
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct Caret<'t> {
...
impl ToSpan for FlatRootBinding<'_> {
    fn span(&self) -> Span {
        match self {
            FlatRootBinding::ValueBinding(v) => v.span(),
...
impl ToSpan for RootBinding<'_> {
    fn span(&self) -> Span {
        match self {
            RootBinding::RootValueBinding(v) => v.span(),
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct RootTextBindingOpt0<'t> {
    pub text: Text<'t>,
}
...
#[allow(dead_code)]
#[derive(Debug, Clone)]
pub struct RootTextBindingOpt1<'t> {
    pub grammar_newline: GrammarNewline<'t>,
}
...
impl ToSpan for RootValueBinding<'_> {
    fn span(&self) -> Span {
        self.newline_bind.span() + self.value.span()
    }
}
...
impl ToSpan for SectionBody<'_> {
    fn span(&self) -> Span {
        match self {
            SectionBody::SectionBodyOpt(v) => v.span(),
...
impl ToSpan for SectionHead<'_> {
    fn span(&self) -> Span {
        match self {
            SectionHead::RootBinding(v) => v.span(),
...
impl ToSpan for TopLevelBinding<'_> {
    fn span(&self) -> Span {
        match self {
            TopLevelBinding::ValueBinding(v) => v.span(),
...
pub enum ASTType<'t> {
    ...
    ArrayMarkerOptGroup(ArrayMarkerOptGroup<'t>),
...
impl ToSpan for ASTType<'_> {
    fn span(&self) -> Span {
        match self {
            ...
            ASTType::ArrayMarkerOptGroup(v) => v.span(),
...
impl<'t, 'u> GrammarAuto<'t, 'u> {
    ...
    ///
    #[parol_runtime::function_name::named]
    fn eure_opt_0(&mut self, _top_level_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let top_level_binding = pop_item!(self, top_level_binding, TopLevelBinding, context);
        let eure_opt_0_built = EureOpt { top_level_binding };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn top_level_binding_0(&mut self, _value_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let value_binding = pop_item!(self, value_binding, ValueBinding, context);
        let top_level_binding_0_built = TopLevelBindingValueBinding { value_binding };
        let top_level_binding_0_built = TopLevelBinding::ValueBinding(top_level_binding_0_built);
        // Calling user action here
        self.user_grammar
            .top_level_binding(&top_level_binding_0_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn top_level_binding_1(&mut self, _text_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let text_binding = pop_item!(self, text_binding, TextBinding, context);
        let top_level_binding_1_built = TopLevelBindingTextBinding { text_binding };
        let top_level_binding_1_built = TopLevelBinding::TextBinding(top_level_binding_1_built);
        // Calling user action here
        self.user_grammar
            .top_level_binding(&top_level_binding_1_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_binding_0(&mut self, _root_value_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let root_value_binding = pop_item!(self, root_value_binding, RootValueBinding, context);
        let root_binding_0_built = RootBindingRootValueBinding { root_value_binding };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_binding_1(&mut self, _root_text_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let root_text_binding = pop_item!(self, root_text_binding, RootTextBinding, context);
        let root_binding_1_built = RootBindingRootTextBinding { root_text_binding };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_value_binding(
        &mut self,
        _newline_bind: &ParseTreeType<'t>,
        _value: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let value = pop_item!(self, value, Value, context);
        let newline_bind = pop_item!(self, newline_bind, NewlineBind, context);
        ...
        // Calling user action here
        self.user_grammar
            .root_value_binding(&root_value_binding_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding(
        &mut self,
        _newline_text_start: &ParseTreeType<'t>,
        _root_text_binding_opt: &ParseTreeType<'t>,
        _root_text_binding_opt0: &ParseTreeType<'t>,
        _root_text_binding_opt1: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let root_text_binding_opt1 =
            pop_item!(self, root_text_binding_opt1, RootTextBindingOpt1, context);
        let root_text_binding_opt0 =
            pop_item!(self, root_text_binding_opt0, RootTextBindingOpt0, context);
        let root_text_binding_opt =
            pop_item!(self, root_text_binding_opt, RootTextBindingOpt, context);
        let newline_text_start = pop_item!(self, newline_text_start, NewlineTextStart, context);
        ...
        // Calling user action here
        self.user_grammar
            .root_text_binding(&root_text_binding_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding_opt1_0(&mut self, _grammar_newline: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let grammar_newline = pop_item!(self, grammar_newline, GrammarNewline, context);
        let root_text_binding_opt1_0_built = RootTextBindingOpt1 { grammar_newline };
        self.push(
            ASTType::RootTextBindingOpt1(Some(root_text_binding_opt1_0_built)),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding_opt1_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding_opt0_0(&mut self, _text: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let text = pop_item!(self, text, Text, context);
        let root_text_binding_opt0_0_built = RootTextBindingOpt0 { text };
        self.push(
            ASTType::RootTextBindingOpt0(Some(root_text_binding_opt0_0_built)),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding_opt0_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding_opt_0(&mut self, _ws: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        self.pop(context);
        let root_text_binding_opt_0_built = RootTextBindingOpt {};
        self.push(
            ASTType::RootTextBindingOpt(Some(root_text_binding_opt_0_built)),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn root_text_binding_opt_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    fn text_binding(
        ...
        _text_binding_opt1: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let text_binding_opt1 = pop_item!(self, text_binding_opt1, TextBindingOpt1, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn text_binding_opt1_0(&mut self, _grammar_newline: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let grammar_newline = pop_item!(self, grammar_newline, GrammarNewline, context);
        let text_binding_opt1_0_built = TextBindingOpt1 { grammar_newline };
        self.push(
            ASTType::TextBindingOpt1(Some(text_binding_opt1_0_built)),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn text_binding_opt1_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn text_binding_opt0_0(&mut self, _text: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let text = pop_item!(self, text, Text, context);
        let text_binding_opt0_0_built = TextBindingOpt0 { text };
        self.push(
    ...
    ///
    #[parol_runtime::function_name::named]
    fn section_body_0(&mut self, _section_body_opt: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let section_body_opt = pop_item!(self, section_body_opt, SectionBodyOpt, context);
        let section_body_0_built = SectionBodySectionBodyOpt { section_body_opt };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn section_body_1(&mut self, _block_body: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let block_body = pop_item!(self, block_body, BlockBody, context);
        let section_body_1_built = SectionBodyBlockBody { block_body };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn section_body_opt_0(&mut self, _flat_body: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let flat_body = pop_item!(self, flat_body, FlatBody, context);
        let section_body_opt_0_built = SectionBodyOpt { flat_body };
        self.push(
    ...
    fn flat_body(
        &mut self,
        _section_head: &ParseTreeType<'t>,
        _flat_body_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let flat_body_list = pop_and_reverse_item!(self, flat_body_list, FlatBodyList, context);
        let section_head = pop_item!(self, section_head, SectionHead, context);
    ...
    fn flat_body_list_0(
        ...
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut flat_body_list = pop_item!(self, flat_body_list, FlatBodyList, context);
        let binding = pop_item!(self, binding, Binding, context);
        let flat_body_list_0_built = FlatBodyList { binding };
        // Add an element to the vector
    ...
    ///
    #[parol_runtime::function_name::named]
    fn flat_body_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn section_head_0(&mut self, _root_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let root_binding = pop_item!(self, root_binding, RootBinding, context);
        let section_head_0_built = SectionHeadRootBinding { root_binding };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn section_head_1(&mut self, _newline_head: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let newline_head = pop_item!(self, newline_head, NewlineHead, context);
        let section_head_1_built = SectionHeadNewlineHead { newline_head };
    ...
    fn newline_head(
        ...
        _newline_head_opt: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let newline_head_opt = pop_item!(self, newline_head_opt, NewlineHeadOpt, context);
        let grammar_newline = pop_item!(self, grammar_newline, GrammarNewline, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn newline_head_opt_0(&mut self, _flat_root_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let flat_root_binding = pop_item!(self, flat_root_binding, FlatRootBinding, context);
        let newline_head_opt_0_built = NewlineHeadOpt { flat_root_binding };
        self.push(
            ASTType::NewlineHeadOpt(Some(newline_head_opt_0_built)),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn newline_head_opt_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn flat_root_binding_0(&mut self, _value_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let value_binding = pop_item!(self, value_binding, ValueBinding, context);
        let flat_root_binding_0_built = FlatRootBindingValueBinding { value_binding };
        let flat_root_binding_0_built = FlatRootBinding::ValueBinding(flat_root_binding_0_built);
        // Calling user action here
        self.user_grammar
            .flat_root_binding(&flat_root_binding_0_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn flat_root_binding_1(&mut self, _text_binding: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let text_binding = pop_item!(self, text_binding, TextBinding, context);
        let flat_root_binding_1_built = FlatRootBindingTextBinding { text_binding };
        let flat_root_binding_1_built = FlatRootBinding::TextBinding(flat_root_binding_1_built);
        // Calling user action here
        self.user_grammar
            .flat_root_binding(&flat_root_binding_1_built)?;
    ...
    fn block_body(
        ...
        let eure = pop_item!(self, eure, Eure, context);
        let begin = pop_item!(self, begin, Begin, context);
        let block_body_built = BlockBody { begin, eure, end };
        // Calling user action here
    ...
    fn keys_list_0(
        &mut self,
        _key_tail: &ParseTreeType<'t>,
        _keys_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut keys_list = pop_item!(self, keys_list, KeysList, context);
        let key_tail = pop_item!(self, key_tail, KeyTail, context);
        let keys_list_0_built = KeysList { key_tail };
        // Add an element to the vector
    ...
    ///
    #[parol_runtime::function_name::named]
    fn first_key_0(&mut self, _key: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let key = pop_item!(self, key, Key, context);
        let first_key_0_built = FirstKeyKey { key };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn first_key_1(&mut self, _array_marker: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let array_marker = pop_item!(self, array_marker, ArrayMarker, context);
        let first_key_1_built = FirstKeyArrayMarker { array_marker };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_tail_0(&mut self, _dot_key: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let dot_key = pop_item!(self, dot_key, DotKey, context);
        let key_tail_0_built = KeyTailDotKey { dot_key };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_tail_1(&mut self, _array_marker: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let array_marker = pop_item!(self, array_marker, ArrayMarker, context);
        let key_tail_1_built = KeyTailArrayMarker { array_marker };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn dot_key(&mut self, _dot: &ParseTreeType<'t>, _key: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let key = pop_item!(self, key, Key, context);
        let dot = pop_item!(self, dot, Dot, context);
        let dot_key_built = DotKey { dot, key };
        // Calling user action here
    ...
    ///
    /// `ArrayMarkerOpt /* Option<T>::Some */: ArrayMarkerOptGroup;`
    ///
    #[parol_runtime::function_name::named]
    fn array_marker_opt_0(&mut self, _array_marker_opt_group: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let array_marker_opt_group =
            pop_item!(self, array_marker_opt_group, ArrayMarkerOptGroup, context);
        let array_marker_opt_0_built = ArrayMarkerOpt {
            array_marker_opt_group,
        };
        self.push(
    ...
    ///
    #[parol_runtime::function_name::named]
    fn array_marker_opt_group_0(&mut self, _integer: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let integer = pop_item!(self, integer, Integer, context);
        let array_marker_opt_group_0_built = ArrayMarkerOptGroupInteger { integer };
        let array_marker_opt_group_0_built =
            ArrayMarkerOptGroup::Integer(array_marker_opt_group_0_built);
        self.push(
            ASTType::ArrayMarkerOptGroup(array_marker_opt_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn array_marker_opt_group_1(&mut self, _caret: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let caret = pop_item!(self, caret, Caret, context);
        let array_marker_opt_group_1_built = ArrayMarkerOptGroupCaret { caret };
        let array_marker_opt_group_1_built =
            ArrayMarkerOptGroup::Caret(array_marker_opt_group_1_built);
        self.push(
            ASTType::ArrayMarkerOptGroup(array_marker_opt_group_1_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_0(&mut self, _key_ident: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let key_ident = pop_item!(self, key_ident, KeyIdent, context);
        let key_0_built = KeyKeyIdent { key_ident };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_1(&mut self, _extension_name_space: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_2(&mut self, _string: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let string = pop_item!(self, string, String, context);
        let key_2_built = KeyString { string };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_3(&mut self, _integer: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let integer = pop_item!(self, integer, Integer, context);
        let key_3_built = KeyInteger { integer };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_4(&mut self, _float: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let float = pop_item!(self, float, Float, context);
        let key_4_built = KeyFloat { float };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_5(&mut self, _key_tuple: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let key_tuple = pop_item!(self, key_tuple, KeyTuple, context);
        let key_5_built = KeyKeyTuple { key_tuple };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_6(&mut self, _tuple_index: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let tuple_index = pop_item!(self, tuple_index, TupleIndex, context);
        let key_6_built = KeyTupleIndex { tuple_index };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_7(&mut self, _hole: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let hole = pop_item!(self, hole, Hole, context);
        let key_7_built = KeyHole { hole };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn key_value_4(&mut self, _hole: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let hole = pop_item!(self, hole, Hole, context);
        let key_value_4_built = KeyValueHole { hole };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn value_3(&mut self, _number: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let number = pop_item!(self, number, Number, context);
        let value_3_built = ValueNumber { number };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn value_9(&mut self, _inline_code: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let inline_code = pop_item!(self, inline_code, InlineCode, context);
        let value_9_built = ValueInlineCode { inline_code };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn number_2(&mut self, _inf: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let inf = pop_item!(self, inf, Inf, context);
        let number_2_built = NumberInf { inf };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn number_3(&mut self, _na_n: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let na_n = pop_item!(self, na_n, NaN, context);
        let number_3_built = NumberNaN { na_n };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn inf(&mut self, inf: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let inf = inf.token()?.clone();
        let inf_built = Inf { inf };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn na_n(&mut self, na_n: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let na_n = na_n.token()?.clone();
        let na_n_built = NaN { na_n };
        // Calling user action here
    ...
    ///
    /// `Hole: <INITIAL, Header>/![\p{XID_Start}_]?[\p{XID_Continue}-]*/;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    #[parol_runtime::function_name::named]
    fn string_0(&mut self, _str: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let str = pop_item!(self, str, Str, context);
        let string_0_built = StringStr { str };
    ...
    fn strings_list_0(
        ...
        let strings_list_0_built = StringsList { string, r#continue };
        // Add an element to the vector
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str(&mut self, lit_str: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str = lit_str.token()?.clone();
        let lit_str_built = LitStr { lit_str };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn inline_code_0(&mut self, _delim_code: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code = pop_item!(self, delim_code, DelimCode, context);
        let inline_code_0_built = InlineCodeDelimCode { delim_code };
    ...
    fn lit_str1(
        &mut self,
        _lit_str1_start: &ParseTreeType<'t>,
        _lit_str1_list: &ParseTreeType<'t>,
        _lit_str1_end: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str1_end = pop_item!(self, lit_str1_end, LitStr1End, context);
        let lit_str1_list = pop_and_reverse_item!(self, lit_str1_list, LitStr1List, context);
        let lit_str1_start = pop_item!(self, lit_str1_start, LitStr1Start, context);
    ...
    fn lit_str1_list_0(
        &mut self,
        _lit_str1_list_group: &ParseTreeType<'t>,
        _lit_str1_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut lit_str1_list = pop_item!(self, lit_str1_list, LitStr1List, context);
        let lit_str1_list_group = pop_item!(self, lit_str1_list_group, LitStr1ListGroup, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str1_list_group_0(&mut self, _no_s_quote: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_s_quote = pop_item!(self, no_s_quote, NoSQuote, context);
        let lit_str1_list_group_0_built = LitStr1ListGroupNoSQuote { no_s_quote };
        let lit_str1_list_group_0_built = LitStr1ListGroup::NoSQuote(lit_str1_list_group_0_built);
        self.push(
            ASTType::LitStr1ListGroup(lit_str1_list_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str1_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    fn lit_str2(
        &mut self,
        _lit_str2_start: &ParseTreeType<'t>,
        _lit_str2_list: &ParseTreeType<'t>,
        _lit_str2_end: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str2_end = pop_item!(self, lit_str2_end, LitStr2End, context);
        let lit_str2_list = pop_and_reverse_item!(self, lit_str2_list, LitStr2List, context);
        let lit_str2_start = pop_item!(self, lit_str2_start, LitStr2Start, context);
    ...
    fn lit_str2_list_0(
        &mut self,
        _lit_str2_list_group: &ParseTreeType<'t>,
        _lit_str2_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut lit_str2_list = pop_item!(self, lit_str2_list, LitStr2List, context);
        let lit_str2_list_group = pop_item!(self, lit_str2_list_group, LitStr2ListGroup, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str2_list_group_0(&mut self, _no_s_quote: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_s_quote = pop_item!(self, no_s_quote, NoSQuote, context);
        let lit_str2_list_group_0_built = LitStr2ListGroupNoSQuote { no_s_quote };
        let lit_str2_list_group_0_built = LitStr2ListGroup::NoSQuote(lit_str2_list_group_0_built);
        self.push(
            ASTType::LitStr2ListGroup(lit_str2_list_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str2_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    fn lit_str3(
        &mut self,
        _lit_str3_start: &ParseTreeType<'t>,
        _lit_str3_list: &ParseTreeType<'t>,
        _lit_str3_end: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str3_end = pop_item!(self, lit_str3_end, LitStr3End, context);
        let lit_str3_list = pop_and_reverse_item!(self, lit_str3_list, LitStr3List, context);
        let lit_str3_start = pop_item!(self, lit_str3_start, LitStr3Start, context);
    ...
    fn lit_str3_list_0(
        &mut self,
        _lit_str3_list_group: &ParseTreeType<'t>,
        _lit_str3_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut lit_str3_list = pop_item!(self, lit_str3_list, LitStr3List, context);
        let lit_str3_list_group = pop_item!(self, lit_str3_list_group, LitStr3ListGroup, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str3_list_group_0(&mut self, _no_s_quote: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_s_quote = pop_item!(self, no_s_quote, NoSQuote, context);
        let lit_str3_list_group_0_built = LitStr3ListGroupNoSQuote { no_s_quote };
        let lit_str3_list_group_0_built = LitStr3ListGroup::NoSQuote(lit_str3_list_group_0_built);
        self.push(
            ASTType::LitStr3ListGroup(lit_str3_list_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str3_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_0(&mut self, _delim_code3: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code3 = pop_item!(self, delim_code3, DelimCode3, context);
        let delim_code_0_built = DelimCodeDelimCode3 { delim_code3 };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_1(&mut self, _delim_code2: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code2 = pop_item!(self, delim_code2, DelimCode2, context);
        let delim_code_1_built = DelimCodeDelimCode2 { delim_code2 };
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_2(&mut self, _delim_code1: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code1 = pop_item!(self, delim_code1, DelimCode1, context);
        let delim_code_2_built = DelimCodeDelimCode1 { delim_code1 };
    ...
    fn delim_code1(
        &mut self,
        _delim_code_start1: &ParseTreeType<'t>,
        _delim_code1_list: &ParseTreeType<'t>,
        _delim_code_end1: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_end1 = pop_item!(self, delim_code_end1, DelimCodeEnd1, context);
        let delim_code1_list =
            pop_and_reverse_item!(self, delim_code1_list, DelimCode1List, context);
        let delim_code_start1 = pop_item!(self, delim_code_start1, DelimCodeStart1, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code1_list_0(
        &mut self,
        _delim_code1_list_group: &ParseTreeType<'t>,
        _delim_code1_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut delim_code1_list = pop_item!(self, delim_code1_list, DelimCode1List, context);
        let delim_code1_list_group =
            pop_item!(self, delim_code1_list_group, DelimCode1ListGroup, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code1_list_group_0(&mut self, _no_backtick: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_backtick = pop_item!(self, no_backtick, NoBacktick, context);
        let delim_code1_list_group_0_built = DelimCode1ListGroupNoBacktick { no_backtick };
        let delim_code1_list_group_0_built =
            DelimCode1ListGroup::NoBacktick(delim_code1_list_group_0_built);
        self.push(
            ASTType::DelimCode1ListGroup(delim_code1_list_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code1_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    fn delim_code2(
        &mut self,
        _delim_code_start2: &ParseTreeType<'t>,
        _delim_code2_list: &ParseTreeType<'t>,
        _delim_code_end2: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_end2 = pop_item!(self, delim_code_end2, DelimCodeEnd2, context);
        let delim_code2_list =
            pop_and_reverse_item!(self, delim_code2_list, DelimCode2List, context);
        let delim_code_start2 = pop_item!(self, delim_code_start2, DelimCodeStart2, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code2_list_0(
        &mut self,
        _delim_code2_list_group: &ParseTreeType<'t>,
        _delim_code2_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut delim_code2_list = pop_item!(self, delim_code2_list, DelimCode2List, context);
        let delim_code2_list_group =
            pop_item!(self, delim_code2_list_group, DelimCode2ListGroup, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code2_list_group_0(&mut self, _no_backtick: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_backtick = pop_item!(self, no_backtick, NoBacktick, context);
        let delim_code2_list_group_0_built = DelimCode2ListGroupNoBacktick { no_backtick };
        let delim_code2_list_group_0_built =
            DelimCode2ListGroup::NoBacktick(delim_code2_list_group_0_built);
        self.push(
            ASTType::DelimCode2ListGroup(delim_code2_list_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code2_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    fn delim_code3(
        &mut self,
        _delim_code_start3: &ParseTreeType<'t>,
        _delim_code3_list: &ParseTreeType<'t>,
        _delim_code_end3: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_end3 = pop_item!(self, delim_code_end3, DelimCodeEnd3, context);
        let delim_code3_list =
            pop_and_reverse_item!(self, delim_code3_list, DelimCode3List, context);
        let delim_code_start3 = pop_item!(self, delim_code_start3, DelimCodeStart3, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code3_list_0(
        &mut self,
        _delim_code3_list_group: &ParseTreeType<'t>,
        _delim_code3_list: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let mut delim_code3_list = pop_item!(self, delim_code3_list, DelimCode3List, context);
        let delim_code3_list_group =
            pop_item!(self, delim_code3_list_group, DelimCode3ListGroup, context);
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code3_list_group_0(&mut self, _no_backtick: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_backtick = pop_item!(self, no_backtick, NoBacktick, context);
        let delim_code3_list_group_0_built = DelimCode3ListGroupNoBacktick { no_backtick };
        let delim_code3_list_group_0_built =
            DelimCode3ListGroup::NoBacktick(delim_code3_list_group_0_built);
        self.push(
            ASTType::DelimCode3ListGroup(delim_code3_list_group_0_built),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code3_list_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str3_start(&mut self, lit_str3_start: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str3_start = lit_str3_start.token()?.clone();
        let lit_str3_start_built = LitStr3Start { lit_str3_start };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str2_start(&mut self, lit_str2_start: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str2_start = lit_str2_start.token()?.clone();
        let lit_str2_start_built = LitStr2Start { lit_str2_start };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str1_start(&mut self, lit_str1_start: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str1_start = lit_str1_start.token()?.clone();
        let lit_str1_start_built = LitStr1Start { lit_str1_start };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_start3(&mut self, delim_code_start3: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_start3 = delim_code_start3.token()?.clone();
        let delim_code_start3_built = DelimCodeStart3 { delim_code_start3 };
        // Calling user action here
        self.user_grammar
            .delim_code_start3(&delim_code_start3_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_start2(&mut self, delim_code_start2: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_start2 = delim_code_start2.token()?.clone();
        let delim_code_start2_built = DelimCodeStart2 { delim_code_start2 };
        // Calling user action here
        self.user_grammar
            .delim_code_start2(&delim_code_start2_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_start1(&mut self, delim_code_start1: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_start1 = delim_code_start1.token()?.clone();
        let delim_code_start1_built = DelimCodeStart1 { delim_code_start1 };
        // Calling user action here
        self.user_grammar
            .delim_code_start1(&delim_code_start1_built)?;
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str3_end(&mut self, lit_str3_end: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str3_end = lit_str3_end.token()?.clone();
        let lit_str3_end_built = LitStr3End { lit_str3_end };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str2_end(&mut self, lit_str2_end: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str2_end = lit_str2_end.token()?.clone();
        let lit_str2_end_built = LitStr2End { lit_str2_end };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn lit_str1_end(&mut self, lit_str1_end: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let lit_str1_end = lit_str1_end.token()?.clone();
        let lit_str1_end_built = LitStr1End { lit_str1_end };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn no_s_quote(&mut self, no_s_quote: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let no_s_quote = no_s_quote.token()?.clone();
        let no_s_quote_built = NoSQuote { no_s_quote };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_end3(&mut self, delim_code_end3: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_end3 = delim_code_end3.token()?.clone();
        let delim_code_end3_built = DelimCodeEnd3 { delim_code_end3 };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_end2(&mut self, delim_code_end2: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_end2 = delim_code_end2.token()?.clone();
        let delim_code_end2_built = DelimCodeEnd2 { delim_code_end2 };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn delim_code_end1(&mut self, delim_code_end1: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let delim_code_end1 = delim_code_end1.token()?.clone();
        let delim_code_end1_built = DelimCodeEnd1 { delim_code_end1 };
        // Calling user action here
    ...
    ///
    /// `Caret: <INITIAL, Header>'^';`
    ///
    #[parol_runtime::function_name::named]
    fn caret(&mut self, caret: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let caret = caret.token()?.clone();
        let caret_built = Caret { caret };
        // Calling user action here
        self.user_grammar.caret(&caret_built)?;
        self.push(ASTType::Caret(caret_built), context);
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn newline_bind(&mut self, newline_bind: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let newline_bind = newline_bind.token()?.clone();
        let newline_bind_built = NewlineBind { newline_bind };
        // Calling user action here
    ...
    ///
    #[parol_runtime::function_name::named]
    fn newline_text_start(&mut self, newline_text_start: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let newline_text_start = newline_text_start.token()?.clone();
        let newline_text_start_built = NewlineTextStart { newline_text_start };
        // Calling user action here
        self.user_grammar
            .newline_text_start(&newline_text_start_built)?;
...
impl<'t> UserActionsTrait<'t> for GrammarAuto<'t, '_> {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            58 => self.array_marker_opt_group_0(&children[0]),
            59 => self.array_marker_opt_group_1(&children[0]),
            60 => self.array_marker_opt_1(),
            61 => self.key_0(&children[0]),
            62 => self.key_1(&children[0]),
            63 => self.key_2(&children[0]),
            64 => self.key_3(&children[0]),
            65 => self.key_4(&children[0]),
            66 => self.key_5(&children[0]),
            67 => self.key_6(&children[0]),
            68 => self.key_7(&children[0]),
            69 => self.tuple_index(&children[0], &children[1]),
            70 => self.extension_name_space(&children[0], &children[1]),
            71 => self.key_tuple(&children[0], &children[1], &children[2]),
            72 => self.key_tuple_opt_0(&children[0]),
            73 => self.key_tuple_opt_1(),
            74 => self.key_tuple_elements(&children[0], &children[1]),
            75 => self.key_tuple_elements_opt_0(&children[0]),
            76 => self.key_tuple_elements_opt_1(),
            77 => self.key_tuple_elements_tail(&children[0], &children[1]),
            78 => self.key_tuple_elements_tail_opt_0(&children[0]),
            79 => self.key_tuple_elements_tail_opt_1(),
            80 => self.key_value_0(&children[0]),
            81 => self.key_value_1(&children[0]),
            82 => self.key_value_2(&children[0]),
            83 => self.key_value_3(&children[0]),
            84 => self.key_value_4(&children[0]),
            85 => self.key_ident_0(&children[0]),
            86 => self.key_ident_1(&children[0]),
            87 => self.key_ident_2(&children[0]),
            88 => self.key_ident_3(&children[0]),
            89 => self.value_0(&children[0]),
            90 => self.value_1(&children[0]),
            91 => self.value_2(&children[0]),
            92 => self.value_3(&children[0]),
            93 => self.value_4(&children[0]),
            94 => self.value_5(&children[0]),
            95 => self.value_6(&children[0]),
            96 => self.value_7(&children[0]),
            97 => self.value_8(&children[0]),
            98 => self.value_9(&children[0]),
            99 => self.object(&children[0], &children[1], &children[2], &children[3]),
            100 => self.object_list_0(
                &children[0],
                &children[1],
                &children[2],
                &children[3],
            ...
            101 => self.object_list_1(),
            102 => self.object_opt0_0(&children[0]),
            103 => self.object_opt0_1(),
            104 => self.object_opt_0(&children[0], &children[1]),
            105 => self.object_opt1_0(&children[0]),
            106 => self.object_opt1_1(),
            107 => self.object_opt_1(),
            108 => self.map_bind(&children[0]),
            109 => self.array(&children[0], &children[1], &children[2]),
            110 => self.array_opt_0(&children[0]),
            111 => self.array_opt_1(),
            112 => self.array_elements(&children[0], &children[1]),
            113 => self.array_elements_opt_0(&children[0]),
            114 => self.array_elements_opt_1(),
            115 => self.array_elements_tail(&children[0], &children[1]),
            116 => self.array_elements_tail_opt_0(&children[0]),
            117 => self.array_elements_tail_opt_1(),
            118 => self.tuple(&children[0], &children[1], &children[2]),
            119 => self.tuple_opt_0(&children[0]),
            120 => self.tuple_opt_1(),
            121 => self.tuple_elements(&children[0], &children[1]),
            122 => self.tuple_elements_opt_0(&children[0]),
            123 => self.tuple_elements_opt_1(),
            124 => self.tuple_elements_tail(&children[0], &children[1]),
            125 => self.tuple_elements_tail_opt_0(&children[0]),
            126 => self.tuple_elements_tail_opt_1(),
            127 => self.number_0(&children[0]),
            128 => self.number_1(&children[0]),
            129 => self.number_2(&children[0]),
            130 => self.number_3(&children[0]),
            131 => self.integer(&children[0]),
            132 => self.float(&children[0]),
            133 => self.inf(&children[0]),
            134 => self.na_n(&children[0]),
            135 => self.boolean_0(&children[0]),
            136 => self.boolean_1(&children[0]),
            137 => self.r#true(&children[0]),
            138 => self.r#false(&children[0]),
            139 => self.null(&children[0]),
            140 => self.hole(&children[0]),
            141 => self.string_0(&children[0]),
            142 => self.string_1(&children[0]),
            143 => self.string_2(&children[0]),
            144 => self.string_3(&children[0]),
            145 => self.string_4(&children[0]),
            146 => self.strings(&children[0], &children[1]),
            147 => self.strings_list_0(&children[0], &children[1], &children[2]),
            148 => self.strings_list_1(),
            149 => self.str(&children[0]),
            150 => self.lit_str(&children[0]),
            151 => self.text(&children[0]),
            152 => self.inline_code_0(&children[0]),
            153 => self.inline_code_1(&children[0]),
            154 => self.inline_code1(&children[0]),
            155 => self.lit_str1(&children[0], &children[1], &children[2]),
            156 => self.lit_str1_list_0(&children[0], &children[1]),
            157 => self.lit_str1_list_group_0(&children[0]),
            158 => self.lit_str1_list_group_1(&children[0]),
            159 => self.lit_str1_list_1(),
            160 => self.lit_str2(&children[0], &children[1], &children[2]),
            161 => self.lit_str2_list_0(&children[0], &children[1]),
            162 => self.lit_str2_list_group_0(&children[0]),
            163 => self.lit_str2_list_group_1(&children[0]),
            164 => self.lit_str2_list_1(),
            165 => self.lit_str3(&children[0], &children[1], &children[2]),
            166 => self.lit_str3_list_0(&children[0], &children[1]),
            167 => self.lit_str3_list_group_0(&children[0]),
            168 => self.lit_str3_list_group_1(&children[0]),
            169 => self.lit_str3_list_1(),
            170 => self.delim_code_0(&children[0]),
            171 => self.delim_code_1(&children[0]),
            172 => self.delim_code_2(&children[0]),
            173 => self.delim_code1(&children[0], &children[1], &children[2]),
            174 => self.delim_code1_list_0(&children[0], &children[1]),
            175 => self.delim_code1_list_group_0(&children[0]),
            176 => self.delim_code1_list_group_1(&children[0]),
            177 => self.delim_code1_list_1(),
            178 => self.delim_code2(&children[0], &children[1], &children[2]),
            179 => self.delim_code2_list_0(&children[0], &children[1]),
            180 => self.delim_code2_list_group_0(&children[0]),
            181 => self.delim_code2_list_group_1(&children[0]),
            182 => self.delim_code2_list_1(),
            183 => self.delim_code3(&children[0], &children[1], &children[2]),
            184 => self.delim_code3_list_0(&children[0], &children[1]),
            185 => self.delim_code3_list_group_0(&children[0]),
            186 => self.delim_code3_list_group_1(&children[0]),
            187 => self.delim_code3_list_1(),
            188 => self.code_block_0(&children[0]),
            189 => self.code_block_1(&children[0]),
            190 => self.code_block_2(&children[0]),
            191 => self.code_block_3(&children[0]),
            192 => self.code_block3(&children[0], &children[1], &children[2]),
            193 => self.code_block3_list_0(&children[0], &children[1]),
            194 => self.code_block3_list_group_0(&children[0]),
            195 => self.code_block3_list_group_1(&children[0]),
            196 => self.code_block3_list_1(),
            197 => self.code_block4(&children[0], &children[1], &children[2]),
            198 => self.code_block4_list_0(&children[0], &children[1]),
            199 => self.code_block4_list_group_0(&children[0]),
            200 => self.code_block4_list_group_1(&children[0]),
            201 => self.code_block4_list_1(),
            202 => self.code_block5(&children[0], &children[1], &children[2]),
            203 => self.code_block5_list_0(&children[0], &children[1]),
            204 => self.code_block5_list_group_0(&children[0]),
            205 => self.code_block5_list_group_1(&children[0]),
            206 => self.code_block5_list_1(),
            207 => self.code_block6(&children[0], &children[1], &children[2]),
            208 => self.code_block6_list_0(&children[0], &children[1]),
            209 => self.code_block6_list_group_0(&children[0]),
            210 => self.code_block6_list_group_1(&children[0]),
            211 => self.code_block6_list_1(),
            212 => self.lit_str3_start(&children[0]),
            213 => self.lit_str2_start(&children[0]),
            214 => self.lit_str1_start(&children[0]),
            215 => self.delim_code_start3(&children[0]),
            216 => self.delim_code_start2(&children[0]),
            217 => self.delim_code_start1(&children[0]),
            218 => self.code_block_start3(&children[0]),
            219 => self.code_block_start4(&children[0]),
            220 => self.code_block_start5(&children[0]),
            221 => self.code_block_start6(&children[0]),
            222 => self.code_block_end3(&children[0]),
            223 => self.backtick2(&children[0]),
            224 => self.code_block_end4(&children[0]),
            225 => self.backtick3(&children[0]),
            226 => self.code_block_end5(&children[0]),
            227 => self.backtick4(&children[0]),
            228 => self.code_block_end6(&children[0]),
            229 => self.backtick5(&children[0]),
            230 => self.no_backtick(&children[0]),
            231 => self.lit_str3_end(&children[0]),
            232 => self.lit_str2_end(&children[0]),
            233 => self.lit_str1_end(&children[0]),
            234 => self.s_quote(&children[0]),
            235 => self.no_s_quote(&children[0]),
            236 => self.delim_code_end3(&children[0]),
            237 => self.delim_code_end2(&children[0]),
            238 => self.delim_code_end1(&children[0]),
            239 => self.backtick_delim(&children[0]),
            240 => self.grammar_newline(&children[0]),
            241 => self.ws(&children[0]),
            242 => self.at(&children[0]),
            243 => self.ext(&children[0]),
            244 => self.dot(&children[0]),
            245 => self.begin(&children[0]),
            246 => self.end(&children[0]),
            247 => self.array_begin(&children[0]),
            248 => self.array_end(&children[0]),
            249 => self.caret(&children[0]),
            250 => self.l_paren(&children[0]),
            251 => self.r_paren(&children[0]),
            252 => self.newline_bind(&children[0]),
            253 => self.bind(&children[0]),
            254 => self.comma(&children[0]),
            255 => self.r#continue(&children[0]),
            256 => self.newline_text_start(&children[0]),
            257 => self.text_start(&children[0]),
            258 => self.ident(&children[0]),
