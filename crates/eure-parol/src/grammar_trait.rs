...
impl<'t> UserActionsTrait<'t> for GrammarAuto<'t, '_> {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            76 => self.array(&children[0], &children[1], &children[2]),
            77 => self.array_opt_0(&children[0]),
            78 => self.array_opt_1(),
            79 => self.array_elements(&children[0], &children[1]),
            80 => self.array_elements_opt_0(&children[0]),
            81 => self.array_elements_opt_1(),
            82 => self.array_elements_tail(&children[0], &children[1]),
            83 => self.array_elements_tail_opt_0(&children[0]),
            84 => self.array_elements_tail_opt_1(),
            85 => self.tuple(&children[0], &children[1], &children[2]),
            86 => self.tuple_opt_0(&children[0]),
            87 => self.tuple_opt_1(),
            88 => self.tuple_elements(&children[0], &children[1]),
            89 => self.tuple_elements_opt_0(&children[0]),
            90 => self.tuple_elements_opt_1(),
            91 => self.tuple_elements_tail(&children[0], &children[1]),
            92 => self.tuple_elements_tail_opt_0(&children[0]),
            93 => self.tuple_elements_tail_opt_1(),
            94 => self.float(&children[0]),
            95 => self.integer(&children[0]),
            96 => self.boolean_0(&children[0]),
            97 => self.boolean_1(&children[0]),
            98 => self.r#true(&children[0]),
            99 => self.r#false(&children[0]),
            100 => self.null(&children[0]),
            101 => self.hole(&children[0]),
            102 => self.path(&children[0], &children[1]),
            103 => self.strings(&children[0], &children[1]),
            104 => self.strings_list_0(&children[0], &children[1], &children[2]),
            105 => self.strings_list_1(),
            106 => self.str(&children[0]),
            107 => self.text(&children[0]),
            108 => self.inline_code_0(&children[0]),
            109 => self.inline_code_1(&children[0]),
            110 => self.inline_code1(&children[0]),
            111 => self.inline_code2(&children[0], &children[1], &children[2]),
            112 => self.inline_code2_list_0(&children[0], &children[1]),
            113 => self.inline_code2_list_group_0(&children[0]),
            114 => self.inline_code2_list_group_1(&children[0]),
            115 => self.inline_code2_list_1(),
            116 => self.code_block_0(&children[0]),
            117 => self.code_block_1(&children[0]),
            118 => self.code_block_2(&children[0]),
            119 => self.code_block_3(&children[0]),
            120 => self.code_block3(&children[0], &children[1], &children[2]),
            121 => self.code_block3_list_0(&children[0], &children[1]),
            122 => self.code_block3_list_group_0(&children[0]),
            123 => self.code_block3_list_group_1(&children[0]),
            124 => self.code_block3_list_1(),
            125 => self.code_block4(&children[0], &children[1], &children[2]),
            126 => self.code_block4_list_0(&children[0], &children[1]),
            127 => self.code_block4_list_group_0(&children[0]),
            128 => self.code_block4_list_group_1(&children[0]),
            129 => self.code_block4_list_1(),
            130 => self.code_block5(&children[0], &children[1], &children[2]),
            131 => self.code_block5_list_0(&children[0], &children[1]),
            132 => self.code_block5_list_group_0(&children[0]),
            133 => self.code_block5_list_group_1(&children[0]),
            134 => self.code_block5_list_1(),
            135 => self.code_block6(&children[0], &children[1], &children[2]),
            136 => self.code_block6_list_0(&children[0], &children[1]),
            137 => self.code_block6_list_group_0(&children[0]),
            138 => self.code_block6_list_group_1(&children[0]),
            139 => self.code_block6_list_1(),
            140 => self.inline_code_start2(&children[0]),
            141 => self.code_block_start3(&children[0]),
            142 => self.code_block_start4(&children[0]),
            143 => self.code_block_start5(&children[0]),
            144 => self.code_block_start6(&children[0]),
            145 => self.code_block_end3(&children[0]),
            146 => self.backtick2(&children[0]),
            147 => self.code_block_end4(&children[0]),
            148 => self.backtick3(&children[0]),
            149 => self.code_block_end5(&children[0]),
            150 => self.backtick4(&children[0]),
            151 => self.code_block_end6(&children[0]),
            152 => self.backtick5(&children[0]),
            153 => self.inline_code_end2(&children[0]),
            154 => self.backtick1(&children[0]),
            155 => self.no_backtick(&children[0]),
            156 => self.no_backtick_inline(&children[0]),
            157 => self.grammar_newline(&children[0]),
            158 => self.ws(&children[0]),
            159 => self.at(&children[0]),
            160 => self.ext(&children[0]),
            161 => self.dot(&children[0]),
            162 => self.begin(&children[0]),
            163 => self.end(&children[0]),
            164 => self.array_begin(&children[0]),
            165 => self.array_end(&children[0]),
            166 => self.l_paren(&children[0]),
            167 => self.r_paren(&children[0]),
            168 => self.bind(&children[0]),
            169 => self.comma(&children[0]),
            170 => self.r#continue(&children[0]),
            171 => self.text_start(&children[0]),
            172 => self.ident(&children[0]),
