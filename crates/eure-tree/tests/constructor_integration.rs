use eure_tree::{
    generated::constructors::constructors::*,
    generated::constructors::constructors::terminals,
    generated::constructors::branded::*,
...
fn test_constructor_complete_tree() {
    ...
    let root = RootConstructor::builder()
        .eure(eure)
        .build()
        .build();
    ...
    assert!(node_count >= 16, "Expected at least 16 nodes, got {}", node_count);
    ...
    let root_view = root_handle.get_view(&tree).expect("Failed to get root view");
    let document = values.get_eure(&root_view.eure).expect("Failed to get document value");
...
fn test_constructor_array() {
    ...
    let comma2_node = CommaConstructor::builder()
        .comma(comma2)
        .build()
        .build();
    ...
    let comma1_node = CommaConstructor::builder()
        .comma(comma1)
        .build()
        .build();
    ...
    let array = ArrayConstructor::builder()
        ...
        .array_opt(ArrayOptConstructor::builder()
        ...
        match document {
            EureValue::Map(Map(map)) => {
                ...
                match (expected, val_value) {
                    ...
                    ("42", EureValue::I64(42)) => (),
                    _ => panic!("Expected {} to produce matching value, got {:?}", expected, val_value),
                }
            }
            _ => panic!("Expected Map value, got {:?}", document),
        }
...
fn test_constructor_nested_object() {
    ...
    let age_ident = IdentConstructor::builder()
        .ident(age_key)
        .build()
        .build();
    ...
    // Build inner object: { age = 30 }
    let inner_begin = BeginConstructor::builder()
        .l_brace(lbrace2)
        .build()
        .build();
    
    let inner_end = EndConstructor::builder()
        .r_brace(rbrace2)
        .build()
        .build();
    
    let bind3_node = BindConstructor::builder()
        .bind(eq3)
        .build()
        .build();
    ...
    let name_ident = IdentConstructor::builder()
        .ident(name_key)
        .build()
        .build();
    ...
    let alice_str = StrConstructor::builder()
        .str(alice)
        .build()
        .build();
    ...
    let bind1_node = BindConstructor::builder()
        .bind(eq1)
        .build()
        .build();
    
    let bind2_node = BindConstructor::builder()
        .bind(eq2)
        .build()
        .build();
    
    // Data binding
    let data_ident = IdentConstructor::builder()
        .ident(data_key)
        .build()
        .build();
    ...
    let outer_begin = BeginConstructor::builder()
        .l_brace(lbrace1)
        .build()
        .build();
    
    let outer_end = EndConstructor::builder()
        .r_brace(rbrace1)
        .build()
        .build();
    ...
    assert!(node_count >= 40, "Expected at least 40 nodes for nested object, got {}", node_count);
