...
impl TerminalKind {
    pub fn from_terminal_index(index: u16) -> Self {
        match index {
            ...
            20 => Self::Str2Start,
            21 => Self::Str1Start,
            22 => Self::LitStr3Start,
            23 => Self::LitStr2Start,
            24 => Self::LitStr1Start,
            25 => Self::DelimCodeStart3,
            26 => Self::DelimCodeStart2,
            27 => Self::DelimCodeStart1,
            28 => Self::CodeBlockStart3,
            29 => Self::CodeBlockStart4,
            30 => Self::CodeBlockStart5,
            31 => Self::CodeBlockStart6,
            32 => Self::CodeBlockEnd3,
            33 => Self::Backtick2,
            34 => Self::CodeBlockEnd4,
            35 => Self::Backtick3,
            36 => Self::CodeBlockEnd5,
            37 => Self::Backtick4,
            38 => Self::CodeBlockEnd6,
            39 => Self::Backtick5,
            40 => Self::NoBacktick,
            41 => Self::Str3End,
            42 => Self::Str2End,
            ...
            51 => Self::SQuote1,
            52 => Self::NoSQuote,
            53 => Self::DelimCodeEnd3,
            54 => Self::DelimCodeEnd2,
            55 => Self::DelimCodeEnd1,
            56 => Self::BacktickDelim1,
            57 => Self::GrammarNewline,
            58 => Self::Ws,
            59 => Self::At,
            60 => Self::Dollar,
            61 => Self::Dot,
...
impl NonTerminalKind {
    pub fn from_non_terminal_name(name: &str) -> Self {
        match name {
            ...
            "BacktickDelim1" => Self::BacktickDelim1,
            "Begin" => Self::Begin,
            "Bind" => Self::Bind,
            ...
            "Quote2" => Self::Quote2,
            "RParen" => Self::RParen,
            "SQuote1" => Self::SQuote1,
            "SQuote2" => Self::SQuote2,
            ...
            "Str" => Self::Str,
            "Str1" => Self::Str1,
            "Str1End" => Self::Str1End,
            "Str1List" => Self::Str1List,
            "Str1ListGroup" => Self::Str1ListGroup,
            "Str1Start" => Self::Str1Start,
            "Str2" => Self::Str2,
            "Str2End" => Self::Str2End,
            "Str2List" => Self::Str2List,
            "Str2ListGroup" => Self::Str2ListGroup,
            "Str2Start" => Self::Str2Start,
            "Str3" => Self::Str3,
            "Str3End" => Self::Str3End,
            "Str3List" => Self::Str3List,
            "Str3ListGroup" => Self::Str3ListGroup,
            "Str3Start" => Self::Str3Start,
            "String" => Self::String,
...
impl std::fmt::Display for TerminalKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::Str3Start => write!(f, stringify!(Str3Start)),
            Self::Str2Start => write!(f, stringify!(Str2Start)),
            Self::Str1Start => write!(f, stringify!(Str1Start)),
            ...
            Self::Str3End => write!(f, stringify!(Str3End)),
            Self::Str2End => write!(f, stringify!(Str2End)),
            Self::Str1End => write!(f, stringify!(Str1End)),
            Self::Quote2 => write!(f, stringify!(Quote2)),
            Self::Quote1 => write!(f, stringify!(Quote1)),
            Self::NoQuote => write!(f, stringify!(NoQuote)),
            ...
            Self::SQuote2 => write!(f, stringify!(SQuote2)),
            Self::SQuote1 => write!(f, stringify!(SQuote1)),
            ...
            Self::BacktickDelim1 => write!(f, stringify!(BacktickDelim1)),
...
impl std::fmt::Display for NonTerminalKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::Str => write!(f, stringify!(Str)),
            Self::Str1 => write!(f, stringify!(Str1)),
            Self::Str1End => write!(f, stringify!(Str1End)),
            Self::Str1List => write!(f, stringify!(Str1List)),
            Self::Str1ListGroup => write!(f, stringify!(Str1ListGroup)),
            Self::Str1Start => write!(f, stringify!(Str1Start)),
            Self::Str2 => write!(f, stringify!(Str2)),
            Self::Str2End => write!(f, stringify!(Str2End)),
            Self::Str2List => write!(f, stringify!(Str2List)),
            Self::Str2ListGroup => write!(f, stringify!(Str2ListGroup)),
            Self::Str2Start => write!(f, stringify!(Str2Start)),
            Self::Str3 => write!(f, stringify!(Str3)),
            Self::Str3End => write!(f, stringify!(Str3End)),
            Self::Str3List => write!(f, stringify!(Str3List)),
            Self::Str3ListGroup => write!(f, stringify!(Str3ListGroup)),
            Self::Str3Start => write!(f, stringify!(Str3Start)),
