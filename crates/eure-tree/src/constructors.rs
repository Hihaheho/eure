...
impl BacktickDelimConstructor {
    pub fn build(self) -> BacktickDelimNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::BacktickDelim, vec![backtick_delim]);
        BacktickDelimNode {
            node_id,
            builder,
        }
...
impl BlockBodyConstructor {
    pub fn build(self) -> BlockBodyNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::BlockBody, vec![begin, eure, end]);
...
impl DelimCode1ListConstructor {
    ...
    pub fn empty() -> DelimCode1ListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCode1List, Vec::<BuilderNodeId>::new());
        DelimCode1ListNode {
            node_id,
            builder,
        }
    ...
    pub fn build(self) -> DelimCode1ListNode {
        let mut builder = CstBuilder::new();
        let delim_code_1_list_group = builder
            .embed(self.delim_code_1_list_group.builder);
        let delim_code_1_list = builder.embed(self.delim_code_1_list.builder);
        let node_id = builder
            .non_terminal(
...
impl DelimCode1ListGroupConstructor {
    pub fn build(self) -> DelimCode1ListGroupNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCode1ListGroup, vec![child_id]);
...
impl DelimCode2ListConstructor {
    ...
    pub fn empty() -> DelimCode2ListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCode2List, Vec::<BuilderNodeId>::new());
        DelimCode2ListNode {
            node_id,
            builder,
        }
    ...
    pub fn build(self) -> DelimCode2ListNode {
        let mut builder = CstBuilder::new();
        let delim_code_2_list_group = builder
            .embed(self.delim_code_2_list_group.builder);
        let delim_code_2_list = builder.embed(self.delim_code_2_list.builder);
        let node_id = builder
            .non_terminal(
...
impl DelimCode2ListGroupConstructor {
    pub fn build(self) -> DelimCode2ListGroupNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCode2ListGroup, vec![child_id]);
...
impl DelimCode3ListConstructor {
    ...
    pub fn empty() -> DelimCode3ListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCode3List, Vec::<BuilderNodeId>::new());
        DelimCode3ListNode {
            node_id,
            builder,
        }
    ...
    pub fn build(self) -> DelimCode3ListNode {
        let mut builder = CstBuilder::new();
        let delim_code_3_list_group = builder
            .embed(self.delim_code_3_list_group.builder);
        let delim_code_3_list = builder.embed(self.delim_code_3_list.builder);
        let node_id = builder
            .non_terminal(
...
impl DelimCode3ListGroupConstructor {
    pub fn build(self) -> DelimCode3ListGroupNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCode3ListGroup, vec![child_id]);
...
impl DelimCodeEnd1Constructor {
    pub fn build(self) -> DelimCodeEnd1Node {
        ...
        let delim_code_end_1 = builder.embed(self.delim_code_end_1.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCodeEnd1, vec![delim_code_end_1]);
        DelimCodeEnd1Node {
            node_id,
            builder,
        }
...
impl DelimCodeEnd2Constructor {
    pub fn build(self) -> DelimCodeEnd2Node {
        ...
        let delim_code_end_2 = builder.embed(self.delim_code_end_2.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCodeEnd2, vec![delim_code_end_2]);
        DelimCodeEnd2Node {
            node_id,
            builder,
        }
...
impl DelimCodeEnd3Constructor {
    pub fn build(self) -> DelimCodeEnd3Node {
        ...
        let delim_code_end_3 = builder.embed(self.delim_code_end_3.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCodeEnd3, vec![delim_code_end_3]);
        DelimCodeEnd3Node {
            node_id,
            builder,
        }
...
impl DelimCodeStart1Constructor {
    pub fn build(self) -> DelimCodeStart1Node {
        ...
        let delim_code_start_1 = builder.embed(self.delim_code_start_1.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCodeStart1, vec![delim_code_start_1]);
        DelimCodeStart1Node {
            node_id,
            builder,
        }
...
impl DelimCodeStart2Constructor {
    pub fn build(self) -> DelimCodeStart2Node {
        ...
        let delim_code_start_2 = builder.embed(self.delim_code_start_2.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCodeStart2, vec![delim_code_start_2]);
        DelimCodeStart2Node {
            node_id,
            builder,
        }
...
impl DelimCodeStart3Constructor {
    pub fn build(self) -> DelimCodeStart3Node {
        ...
        let delim_code_start_3 = builder.embed(self.delim_code_start_3.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::DelimCodeStart3, vec![delim_code_start_3]);
        DelimCodeStart3Node {
            node_id,
            builder,
        }
...
impl FlatBodyConstructor {
    pub fn build(self) -> FlatBodyNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::FlatBody, vec![section_head, flat_body_list]);
...
impl FlatBodyListConstructor {
    ...
    pub fn empty() -> FlatBodyListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::FlatBodyList, Vec::<BuilderNodeId>::new());
        FlatBodyListNode {
            node_id,
            builder,
        }
    ...
    pub fn build(self) -> FlatBodyListNode {
        ...
        let flat_body_list = builder.embed(self.flat_body_list.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::FlatBodyList, vec![binding, flat_body_list]);
        FlatBodyListNode {
            node_id,
            builder,
        }
...
impl FlatRootBindingConstructor {
    pub fn build(self) -> FlatRootBindingNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::FlatRootBinding, vec![child_id]);
        FlatRootBindingNode {
            node_id,
            builder,
        }
...
impl KeysConstructor {
    pub fn build(self) -> KeysNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::Keys, vec![first_key, keys_list]);
...
impl KeysListConstructor {
    ...
    pub fn build(self) -> KeysListNode {
        ...
        let keys_list = builder.embed(self.keys_list.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::KeysList, vec![key_tail, keys_list]);
        KeysListNode { node_id, builder }
    }
}
#[derive(bon::Builder)]
...
impl LitStr1EndConstructor {
    pub fn build(self) -> LitStr1EndNode {
        ...
        let lit_str_1_end = builder.embed(self.lit_str_1_end.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr1End, vec![lit_str_1_end]);
...
impl LitStr1ListConstructor {
    ...
    pub fn empty() -> LitStr1ListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr1List, Vec::<BuilderNodeId>::new());
        LitStr1ListNode {
            node_id,
            builder,
        }
...
impl LitStr1ListGroupConstructor {
    pub fn build(self) -> LitStr1ListGroupNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr1ListGroup, vec![child_id]);
...
impl LitStr1StartConstructor {
    pub fn build(self) -> LitStr1StartNode {
        ...
        let lit_str_1_start = builder.embed(self.lit_str_1_start.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr1Start, vec![lit_str_1_start]);
        LitStr1StartNode {
            node_id,
            builder,
        }
...
impl LitStr2EndConstructor {
    pub fn build(self) -> LitStr2EndNode {
        ...
        let lit_str_2_end = builder.embed(self.lit_str_2_end.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr2End, vec![lit_str_2_end]);
...
impl LitStr2ListConstructor {
    ...
    pub fn empty() -> LitStr2ListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr2List, Vec::<BuilderNodeId>::new());
        LitStr2ListNode {
            node_id,
            builder,
        }
...
impl LitStr2ListGroupConstructor {
    pub fn build(self) -> LitStr2ListGroupNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr2ListGroup, vec![child_id]);
...
impl LitStr2StartConstructor {
    pub fn build(self) -> LitStr2StartNode {
        ...
        let lit_str_2_start = builder.embed(self.lit_str_2_start.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr2Start, vec![lit_str_2_start]);
        LitStr2StartNode {
            node_id,
            builder,
        }
...
impl LitStr3EndConstructor {
    pub fn build(self) -> LitStr3EndNode {
        ...
        let lit_str_3_end = builder.embed(self.lit_str_3_end.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr3End, vec![lit_str_3_end]);
...
impl LitStr3ListConstructor {
    ...
    pub fn empty() -> LitStr3ListNode {
        let mut builder = CstBuilder::new();
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr3List, Vec::<BuilderNodeId>::new());
        LitStr3ListNode {
            node_id,
            builder,
        }
...
impl LitStr3ListGroupConstructor {
    pub fn build(self) -> LitStr3ListGroupNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr3ListGroup, vec![child_id]);
...
impl LitStr3StartConstructor {
    pub fn build(self) -> LitStr3StartNode {
        ...
        let lit_str_3_start = builder.embed(self.lit_str_3_start.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::LitStr3Start, vec![lit_str_3_start]);
        LitStr3StartNode {
            node_id,
            builder,
        }
...
impl NewlineBindConstructor {
    pub fn build(self) -> NewlineBindNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::NewlineBind, vec![newline_bind]);
        NewlineBindNode {
            node_id,
            builder,
        }
...
impl NewlineTextStartConstructor {
    pub fn build(self) -> NewlineTextStartNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::NewlineTextStart, vec![newline_text_start]);
        NewlineTextStartNode {
            node_id,
            builder,
        }
    }
...
impl RootTextBindingConstructor {
    pub fn build(self) -> RootTextBindingNode {
        ...
        let root_text_binding_opt_0 = builder
            .embed(self.root_text_binding_opt_0.builder);
        let root_text_binding_opt_1 = builder
            .embed(self.root_text_binding_opt_1.builder);
        let node_id = builder
            .non_terminal(
                NonTerminalKind::RootTextBinding,
                vec![
                    newline_text_start, root_text_binding_opt, root_text_binding_opt_0,
...
impl RootTextBindingOptConstructor {
    pub fn build(self) -> RootTextBindingOptNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::RootTextBindingOpt, children);
        RootTextBindingOptNode {
            node_id,
            builder,
        }
    }
...
impl RootTextBindingOpt0Constructor {
    pub fn build(self) -> RootTextBindingOpt0Node {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::RootTextBindingOpt0, children);
        RootTextBindingOpt0Node {
            node_id,
            builder,
        }
    }
...
impl RootTextBindingOpt1Constructor {
    pub fn build(self) -> RootTextBindingOpt1Node {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::RootTextBindingOpt1, children);
        RootTextBindingOpt1Node {
            node_id,
            builder,
        }
    }
...
impl RootValueBindingConstructor {
    pub fn build(self) -> RootValueBindingNode {
        ...
        let value = builder.embed(self.value.builder);
        let node_id = builder
            .non_terminal(NonTerminalKind::RootValueBinding, vec![newline_bind, value]);
        RootValueBindingNode {
            node_id,
            builder,
        }
    }
...
impl StringsConstructor {
    pub fn build(self) -> StringsNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::Strings, vec![string, strings_list]);
    ...
    pub fn build(self) -> TextBindingNode {
        ...
        let node_id = builder
            .non_terminal(
                ...
                vec![
                    text_start, text_binding_opt, text_binding_opt_0, text_binding_opt_1
                ],
            );
        TextBindingNode {
            node_id,
...
impl TopLevelBindingConstructor {
    pub fn build(self) -> TopLevelBindingNode {
        ...
        let node_id = builder
            .non_terminal(NonTerminalKind::TopLevelBinding, vec![child_id]);
        TopLevelBindingNode {
            node_id,
            builder,
        }
