...
pub trait CstVisitor<F: CstFacade>: CstVisitorSuper<F, Self::Error> {
    ...
    fn visit_block_body(
        &mut self,
        handle: BlockBodyHandle,
        view: BlockBodyView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_block_body_super(handle, view, tree)
    }
    fn visit_boolean(
        &mut self,
    ...
    fn visit_dot_key(
        ...
        self.visit_dot_key_super(handle, view, tree)
    }
    fn visit_end(
        &mut self,
        handle: EndHandle,
    ...
    fn visit_first_key(
        &mut self,
        handle: FirstKeyHandle,
        view: FirstKeyView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_first_key_super(handle, view, tree)
    }
    fn visit_flat_body(
        &mut self,
    ...
    fn visit_flat_body_list(
        &mut self,
        handle: FlatBodyListHandle,
        view: FlatBodyListView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_flat_body_list_super(handle, view, tree)
    }
    ...
    fn visit_key_tail(
        &mut self,
        handle: KeyTailHandle,
        view: KeyTailView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_key_tail_super(handle, view, tree)
    }
    fn visit_key_tuple(
        &mut self,
    ...
    fn visit_newline_bind(
        &mut self,
        handle: NewlineBindHandle,
        view: NewlineBindView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_newline_bind_super(handle, view, tree)
    }
    fn visit_newline_head(
        &mut self,
        handle: NewlineHeadHandle,
        view: NewlineHeadView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_newline_head_super(handle, view, tree)
    }
    fn visit_newline_head_opt(
        &mut self,
        handle: NewlineHeadOptHandle,
        view: FlatRootBindingHandle,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_newline_head_opt_super(handle, view, tree)
    }
    fn visit_newline_text_start(
        &mut self,
        handle: NewlineTextStartHandle,
        view: NewlineTextStartView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_newline_text_start_super(handle, view, tree)
    }
    ...
    fn visit_root_text_binding_opt(
        &mut self,
        handle: RootTextBindingOptHandle,
        view: WsHandle,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_root_text_binding_opt_super(handle, view, tree)
    }
    fn visit_root_text_binding_opt_0(
        &mut self,
        handle: RootTextBindingOpt0Handle,
        view: TextHandle,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_root_text_binding_opt_0_super(handle, view, tree)
    }
    fn visit_root_text_binding_opt_1(
        &mut self,
        handle: RootTextBindingOpt1Handle,
        view: GrammarNewlineHandle,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_root_text_binding_opt_1_super(handle, view, tree)
    }
    fn visit_root_value_binding(
        &mut self,
        handle: RootValueBindingHandle,
        view: RootValueBindingView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_root_value_binding_super(handle, view, tree)
    }
    fn visit_s_quote(
        &mut self,
        handle: SQuoteHandle,
    ...
    fn visit_section_head(
        &mut self,
        handle: SectionHeadHandle,
        view: SectionHeadView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_section_head_super(handle, view, tree)
    }
    fn visit_str(
        &mut self,
        handle: StrHandle,
    ...
    fn visit_top_level_binding(
        &mut self,
        handle: TopLevelBindingHandle,
        view: TopLevelBindingView,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_top_level_binding_super(handle, view, tree)
    }
    fn visit_true(
        &mut self,
        handle: TrueHandle,
    ...
    fn visit_newline_bind_terminal(
        &mut self,
        terminal: NewlineBind,
        data: TerminalData,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_newline_bind_terminal_super(terminal, data, tree)
    }
    ...
    fn visit_newline_text_start_terminal(
        &mut self,
        terminal: NewlineTextStart,
        data: TerminalData,
        tree: &F,
    ) -> Result<(), Self::Error> {
        self.visit_newline_text_start_terminal_super(terminal, data, tree)
    }
...
pub trait CstVisitorSuper<F: CstFacade, E>: private::Sealed<F> {
    ...
    fn visit_block_body_handle(
        &mut self,
        handle: BlockBodyHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_block_body_super(
        &mut self,
        handle: BlockBodyHandle,
        view: BlockBodyView,
        tree: &F,
    ...
    fn visit_dot_key_handle(&mut self, handle: DotKeyHandle, tree: &F) -> Result<(), E>;
    fn visit_dot_key_super(
        &mut self,
        handle: DotKeyHandle,
        view: DotKeyView,
        tree: &F,
    ...
    fn visit_first_key_handle(
        &mut self,
        handle: FirstKeyHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_first_key_super(
        &mut self,
        handle: FirstKeyHandle,
        view: FirstKeyView,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_flat_body_handle(
        &mut self,
        handle: FlatBodyHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_flat_body_super(
        &mut self,
        handle: FlatBodyHandle,
        view: FlatBodyView,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_flat_body_list_handle(
        &mut self,
        handle: FlatBodyListHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_flat_body_list_super(
        &mut self,
        handle: FlatBodyListHandle,
        view: FlatBodyListView,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_flat_root_binding_handle(
        &mut self,
        handle: FlatRootBindingHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_flat_root_binding_super(
        &mut self,
        handle: FlatRootBindingHandle,
        view: FlatRootBindingView,
        tree: &F,
    ...
    fn visit_key_tail_handle(
        &mut self,
        handle: KeyTailHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_key_tail_super(
        &mut self,
        handle: KeyTailHandle,
        view: KeyTailView,
        tree: &F,
    ...
    fn visit_newline_bind_handle(
        &mut self,
        handle: NewlineBindHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_bind_super(
        &mut self,
        handle: NewlineBindHandle,
        view: NewlineBindView,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_head_handle(
        &mut self,
        handle: NewlineHeadHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_head_super(
        &mut self,
        handle: NewlineHeadHandle,
        view: NewlineHeadView,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_head_opt_handle(
        &mut self,
        handle: NewlineHeadOptHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_head_opt_super(
        &mut self,
        handle: NewlineHeadOptHandle,
        view: FlatRootBindingHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_text_start_handle(
        &mut self,
        handle: NewlineTextStartHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_newline_text_start_super(
        &mut self,
        handle: NewlineTextStartHandle,
        view: NewlineTextStartView,
        tree: &F,
    ...
    fn visit_root_text_binding_handle(
        &mut self,
        handle: RootTextBindingHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_super(
        &mut self,
        handle: RootTextBindingHandle,
        view: RootTextBindingView,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_opt_handle(
        &mut self,
        handle: RootTextBindingOptHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_opt_super(
        &mut self,
        handle: RootTextBindingOptHandle,
        view: WsHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_opt_0_handle(
        &mut self,
        handle: RootTextBindingOpt0Handle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_opt_0_super(
        &mut self,
        handle: RootTextBindingOpt0Handle,
        view: TextHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_opt_1_handle(
        &mut self,
        handle: RootTextBindingOpt1Handle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_text_binding_opt_1_super(
        &mut self,
        handle: RootTextBindingOpt1Handle,
        view: GrammarNewlineHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_value_binding_handle(
        &mut self,
        handle: RootValueBindingHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_root_value_binding_super(
        &mut self,
        handle: RootValueBindingHandle,
        view: RootValueBindingView,
        tree: &F,
    ...
    fn visit_section_head_handle(
        &mut self,
        handle: SectionHeadHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_section_head_super(
        &mut self,
        handle: SectionHeadHandle,
        view: SectionHeadView,
        tree: &F,
    ...
    fn visit_top_level_binding_handle(
        &mut self,
        handle: TopLevelBindingHandle,
        tree: &F,
    ) -> Result<(), E>;
    fn visit_top_level_binding_super(
        &mut self,
        handle: TopLevelBindingHandle,
        view: TopLevelBindingView,
        tree: &F,
    ...
    fn visit_newline_bind_terminal_super(
        &mut self,
        terminal: NewlineBind,
        data: TerminalData,
        tree: &F,
    ...
    fn visit_newline_text_start_terminal_super(
        &mut self,
        terminal: NewlineTextStart,
        data: TerminalData,
        tree: &F,
...
impl<V: CstVisitor<F>, F: CstFacade> CstVisitorSuper<F, V::Error> for V {
    ...
    fn visit_backtick_delim_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_backtick_delim(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_block_body_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_block_body(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_1_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_1(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_2_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_2(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_3_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_3(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_end_1_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_end_1(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_end_2_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_end_2(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_end_3_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_end_3(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_start_1_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_start_1(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_start_2_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_start_2(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_delim_code_start_3_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_delim_code_start_3(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_dot_key_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_dot_key(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_first_key_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_first_key(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_flat_body_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_flat_body(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_flat_body_list_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                ...
                |view, visit: &mut Self| (
                    if let Some(view) = view {
                        visit.visit_flat_body_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_flat_root_binding_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_flat_root_binding(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_key_tail_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_key_tail(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_1_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_1(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_1_end_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_1_end(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_1_list_group_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_1_list_group(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_1_start_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_1_start(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_2_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_2(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_2_end_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_2_end(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_2_list_group_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_2_list_group(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_2_start_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_2_start(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_3_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_3(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_3_end_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_3_end(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_3_list_group_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_3_list_group(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_lit_str_3_start_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_lit_str_3_start(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_map_bind_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_map_bind(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_newline_bind_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_newline_bind(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_newline_head_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_newline_head(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_newline_head_opt_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                ...
                |view, visit: &mut Self| (
                    if let Some(view) = view {
                        visit.visit_newline_head_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_newline_text_start_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_newline_text_start(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_no_s_quote_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_no_s_quote(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_root_text_binding_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_root_text_binding(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_root_text_binding_opt_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                ...
                |view, visit: &mut Self| (
                    if let Some(view) = view {
                        visit.visit_root_text_binding_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_root_text_binding_opt_0_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                ...
                |view, visit: &mut Self| (
                    if let Some(view) = view {
                        visit.visit_root_text_binding_opt_0(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_root_text_binding_opt_1_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                ...
                |view, visit: &mut Self| (
                    if let Some(view) = view {
                        visit.visit_root_text_binding_opt_1(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_root_value_binding_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_root_value_binding(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_s_quote_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_s_quote(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_section_head_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_section_head(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_top_level_binding_handle(
        ...
        let result = match handle
            .get_view_with_visit(
                tree,
                |view, visit: &mut Self| (
                    visit.visit_top_level_binding(handle, view, tree),
                    visit,
                ),
                self,
            )
    ...
    fn visit_block_body_super(
        &mut self,
        handle: BlockBodyHandle,
        view_param: BlockBodyView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let BlockBodyView { begin, eure, end } = view_param;
    ...
    fn visit_delim_code_1_super(
        ...
        let _handle = handle;
        let DelimCode1View { delim_code_start_1, delim_code_1_list, delim_code_end_1 } = view_param;
    ...
    fn visit_delim_code_1_list_super(
        ...
        let _handle = handle;
        let DelimCode1ListView { delim_code_1_list_group, delim_code_1_list } = view_param;
    ...
    fn visit_delim_code_2_super(
        ...
        let _handle = handle;
        let DelimCode2View { delim_code_start_2, delim_code_2_list, delim_code_end_2 } = view_param;
    ...
    fn visit_delim_code_2_list_super(
        ...
        let _handle = handle;
        let DelimCode2ListView { delim_code_2_list_group, delim_code_2_list } = view_param;
    ...
    fn visit_delim_code_3_super(
        ...
        let _handle = handle;
        let DelimCode3View { delim_code_start_3, delim_code_3_list, delim_code_end_3 } = view_param;
    ...
    fn visit_delim_code_3_list_super(
        ...
        let _handle = handle;
        let DelimCode3ListView { delim_code_3_list_group, delim_code_3_list } = view_param;
    ...
    fn visit_dot_key_super(
        &mut self,
        handle: DotKeyHandle,
        view_param: DotKeyView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let DotKeyView { dot, key } = view_param;
    ...
    fn visit_eure_opt_super(
        &mut self,
        handle: EureOptHandle,
        view_param: TopLevelBindingHandle,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        self.visit_top_level_binding_handle(view_param, tree)?;
        Ok(())
    }
    fn visit_ext_super(
        &mut self,
    ...
    fn visit_first_key_super(
        &mut self,
        handle: FirstKeyHandle,
        view_param: FirstKeyView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        match view_param {
            FirstKeyView::Key(item) => {
                self.visit_key_handle(item, tree)?;
            }
            FirstKeyView::ArrayMarker(item) => {
                self.visit_array_marker_handle(item, tree)?;
            }
        }
        Ok(())
    }
    fn visit_flat_body_super(
        &mut self,
        handle: FlatBodyHandle,
        view_param: FlatBodyView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let FlatBodyView { section_head, flat_body_list } = view_param;
        self.visit_section_head_handle(section_head, tree)?;
        self.visit_flat_body_list_handle(flat_body_list, tree)?;
        Ok(())
    }
    fn visit_flat_body_list_super(
        &mut self,
        handle: FlatBodyListHandle,
        view_param: FlatBodyListView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let FlatBodyListView { binding, flat_body_list } = view_param;
        self.visit_binding_handle(binding, tree)?;
        self.visit_flat_body_list_handle(flat_body_list, tree)?;
        Ok(())
    }
    fn visit_flat_root_binding_super(
        &mut self,
        handle: FlatRootBindingHandle,
        view_param: FlatRootBindingView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        match view_param {
            FlatRootBindingView::ValueBinding(item) => {
                self.visit_value_binding_handle(item, tree)?;
            }
            FlatRootBindingView::TextBinding(item) => {
                self.visit_text_binding_handle(item, tree)?;
            }
        }
        Ok(())
    ...
    fn visit_key_tail_super(
        &mut self,
        handle: KeyTailHandle,
        view_param: KeyTailView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        match view_param {
            KeyTailView::DotKey(item) => {
                self.visit_dot_key_handle(item, tree)?;
            }
            KeyTailView::ArrayMarker(item) => {
                self.visit_array_marker_handle(item, tree)?;
            }
        }
        Ok(())
    ...
    fn visit_keys_super(
        ...
        let _handle = handle;
        let KeysView { first_key, keys_list } = view_param;
        self.visit_first_key_handle(first_key, tree)?;
    ...
    fn visit_keys_list_super(
        ...
        let _handle = handle;
        let KeysListView { key_tail, keys_list } = view_param;
        self.visit_key_tail_handle(key_tail, tree)?;
        self.visit_keys_list_handle(keys_list, tree)?;
        Ok(())
    }
    fn visit_l_paren_super(
    ...
    fn visit_lit_str_1_super(
        ...
        let _handle = handle;
        let LitStr1View { lit_str_1_start, lit_str_1_list, lit_str_1_end } = view_param;
    ...
    fn visit_lit_str_1_list_super(
        ...
        let _handle = handle;
        let LitStr1ListView { lit_str_1_list_group, lit_str_1_list } = view_param;
    ...
    fn visit_lit_str_2_super(
        ...
        let _handle = handle;
        let LitStr2View { lit_str_2_start, lit_str_2_list, lit_str_2_end } = view_param;
    ...
    fn visit_lit_str_2_list_super(
        ...
        let _handle = handle;
        let LitStr2ListView { lit_str_2_list_group, lit_str_2_list } = view_param;
    ...
    fn visit_lit_str_3_super(
        ...
        let _handle = handle;
        let LitStr3View { lit_str_3_start, lit_str_3_list, lit_str_3_end } = view_param;
    ...
    fn visit_lit_str_3_list_super(
        ...
        let _handle = handle;
        let LitStr3ListView { lit_str_3_list_group, lit_str_3_list } = view_param;
    ...
    fn visit_newline_bind_super(
        &mut self,
        handle: NewlineBindHandle,
        view_param: NewlineBindView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let NewlineBindView { newline_bind } = view_param;
        let data = match newline_bind.get_data(tree) {
            Ok(data) => data,
            Err(error) => {
                return self
                    .then_construct_error(
                        None,
                        newline_bind.0,
                        NodeKind::Terminal(newline_bind.kind()),
                        error,
                        tree,
                    );
            }
        };
        self.visit_newline_bind_terminal(newline_bind, data, tree)?;
        Ok(())
    }
    fn visit_newline_head_super(
        &mut self,
        handle: NewlineHeadHandle,
        view_param: NewlineHeadView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let NewlineHeadView { grammar_newline, newline_head_opt } = view_param;
        self.visit_grammar_newline_handle(grammar_newline, tree)?;
        self.visit_newline_head_opt_handle(newline_head_opt, tree)?;
        Ok(())
    }
    fn visit_newline_head_opt_super(
        &mut self,
        handle: NewlineHeadOptHandle,
        view_param: FlatRootBindingHandle,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        self.visit_flat_root_binding_handle(view_param, tree)?;
        Ok(())
    }
    fn visit_newline_text_start_super(
        &mut self,
        handle: NewlineTextStartHandle,
        view_param: NewlineTextStartView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let NewlineTextStartView { newline_text_start } = view_param;
        let data = match newline_text_start.get_data(tree) {
            Ok(data) => data,
            Err(error) => {
                return self
                    .then_construct_error(
                        None,
                        newline_text_start.0,
                        NodeKind::Terminal(newline_text_start.kind()),
                        error,
                        tree,
                    );
            }
        };
        self.visit_newline_text_start_terminal(newline_text_start, data, tree)?;
        Ok(())
    }
    fn visit_no_backtick_super(
        &mut self,
    ...
    fn visit_object_super(
        ...
        let _handle = handle;
        let ObjectView { begin, object_opt, object_list, end } = view_param;
        self.visit_begin_handle(begin, tree)?;
    ...
    fn visit_object_list_super(
        ...
        let _handle = handle;
        let ObjectListView { keys, map_bind, value, object_opt_0, object_list } = view_param;
        self.visit_keys_handle(keys, tree)?;
    ...
    fn visit_object_opt_super(
        ...
        let _handle = handle;
        let ObjectOptView { value_binding, object_opt_1 } = view_param;
    ...
    fn visit_root_binding_super(
        ...
        let _handle = handle;
        match view_param {
            RootBindingView::RootValueBinding(item) => {
                self.visit_root_value_binding_handle(item, tree)?;
            }
            RootBindingView::RootTextBinding(item) => {
                self.visit_root_text_binding_handle(item, tree)?;
            }
        }
        Ok(())
    }
    fn visit_root_text_binding_super(
        &mut self,
        handle: RootTextBindingHandle,
        view_param: RootTextBindingView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let RootTextBindingView {
            newline_text_start,
            root_text_binding_opt,
            root_text_binding_opt_0,
            root_text_binding_opt_1,
        } = view_param;
        self.visit_newline_text_start_handle(newline_text_start, tree)?;
        self.visit_root_text_binding_opt_handle(root_text_binding_opt, tree)?;
        self.visit_root_text_binding_opt_0_handle(root_text_binding_opt_0, tree)?;
        self.visit_root_text_binding_opt_1_handle(root_text_binding_opt_1, tree)?;
        Ok(())
    }
    fn visit_root_text_binding_opt_super(
        &mut self,
    ...
    fn visit_root_value_binding_super(
        &mut self,
        handle: RootValueBindingHandle,
        view_param: RootValueBindingView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        let RootValueBindingView { newline_bind, value } = view_param;
        self.visit_newline_bind_handle(newline_bind, tree)?;
        self.visit_value_handle(value, tree)?;
        Ok(())
    }
    fn visit_s_quote_super(
    ...
    fn visit_section_body_super(
        ...
        match view_param {
            ...
            SectionBodyView::BlockBody(item) => {
                self.visit_block_body_handle(item, tree)?;
            }
        }
        Ok(())
    }
    fn visit_section_body_opt_super(
        &mut self,
        handle: SectionBodyOptHandle,
        view_param: FlatBodyHandle,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        self.visit_flat_body_handle(view_param, tree)?;
        Ok(())
    }
    fn visit_section_head_super(
        &mut self,
        handle: SectionHeadHandle,
        view_param: SectionHeadView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        match view_param {
            SectionHeadView::RootBinding(item) => {
                self.visit_root_binding_handle(item, tree)?;
            }
            SectionHeadView::NewlineHead(item) => {
                self.visit_newline_head_handle(item, tree)?;
            }
        }
        Ok(())
    }
    ...
    fn visit_strings_super(
        ...
        let _handle = handle;
        let StringsView { string, strings_list } = view_param;
    ...
    fn visit_strings_list_super(
        ...
        let _handle = handle;
        let StringsListView { r#continue, string, strings_list } = view_param;
    ...
    fn visit_top_level_binding_super(
        &mut self,
        handle: TopLevelBindingHandle,
        view_param: TopLevelBindingView,
        tree: &F,
    ) -> Result<(), V::Error> {
        let _handle = handle;
        match view_param {
            TopLevelBindingView::ValueBinding(item) => {
                self.visit_value_binding_handle(item, tree)?;
            }
            TopLevelBindingView::TextBinding(item) => {
                self.visit_text_binding_handle(item, tree)?;
            }
        }
        Ok(())
            ...
            CstNode::NonTerminal { kind, .. } => {
                match kind {
                    ...
                    NonTerminalKind::BlockBody => {
                        let handle = BlockBodyHandle(id);
                        self.visit_block_body_handle(handle, tree)?;
                    }
                    ...
                    NonTerminalKind::DotKey => {
                        let handle = DotKeyHandle(id);
                        self.visit_dot_key_handle(handle, tree)?;
                    }
                    NonTerminalKind::End => {
                    ...
                    NonTerminalKind::FirstKey => {
                        let handle = FirstKeyHandle(id);
                        self.visit_first_key_handle(handle, tree)?;
                    }
                    NonTerminalKind::FlatBody => {
                        let handle = FlatBodyHandle(id);
                        self.visit_flat_body_handle(handle, tree)?;
                    }
                    NonTerminalKind::FlatBodyList => {
                        let handle = FlatBodyListHandle(id);
                        self.visit_flat_body_list_handle(handle, tree)?;
                    }
                    NonTerminalKind::FlatRootBinding => {
                        let handle = FlatRootBindingHandle(id);
                        self.visit_flat_root_binding_handle(handle, tree)?;
                    }
                    ...
                    NonTerminalKind::KeyTail => {
                        let handle = KeyTailHandle(id);
                        self.visit_key_tail_handle(handle, tree)?;
                    }
                    ...
                    NonTerminalKind::NewlineBind => {
                        let handle = NewlineBindHandle(id);
                        self.visit_newline_bind_handle(handle, tree)?;
                    }
                    NonTerminalKind::NewlineHead => {
                        let handle = NewlineHeadHandle(id);
                        self.visit_newline_head_handle(handle, tree)?;
                    }
                    NonTerminalKind::NewlineHeadOpt => {
                        let handle = NewlineHeadOptHandle(id);
                        self.visit_newline_head_opt_handle(handle, tree)?;
                    }
                    NonTerminalKind::NewlineTextStart => {
                        let handle = NewlineTextStartHandle(id);
                        self.visit_newline_text_start_handle(handle, tree)?;
                    }
                    ...
                    NonTerminalKind::RootTextBinding => {
                        let handle = RootTextBindingHandle(id);
                        self.visit_root_text_binding_handle(handle, tree)?;
                    }
                    NonTerminalKind::RootTextBindingOpt => {
                        let handle = RootTextBindingOptHandle(id);
                        self.visit_root_text_binding_opt_handle(handle, tree)?;
                    }
                    NonTerminalKind::RootTextBindingOpt0 => {
                        let handle = RootTextBindingOpt0Handle(id);
                        self.visit_root_text_binding_opt_0_handle(handle, tree)?;
                    }
                    NonTerminalKind::RootTextBindingOpt1 => {
                        let handle = RootTextBindingOpt1Handle(id);
                        self.visit_root_text_binding_opt_1_handle(handle, tree)?;
                    }
                    NonTerminalKind::RootValueBinding => {
                        let handle = RootValueBindingHandle(id);
                        self.visit_root_value_binding_handle(handle, tree)?;
                    }
                    ...
                    NonTerminalKind::SectionHead => {
                        let handle = SectionHeadHandle(id);
                        self.visit_section_head_handle(handle, tree)?;
                    }
                    NonTerminalKind::Str => {
                    ...
                    NonTerminalKind::TopLevelBinding => {
                        let handle = TopLevelBindingHandle(id);
                        self.visit_top_level_binding_handle(handle, tree)?;
                    }
            ...
            CstNode::Terminal { kind, data } => {
                match kind {
                    ...
                    TerminalKind::NewlineBind => {
                        let terminal = NewlineBind(id);
                        self.visit_newline_bind_terminal(terminal, data, tree)?;
                    }
                    TerminalKind::Bind => {
                    ...
                    TerminalKind::NewlineTextStart => {
                        let terminal = NewlineTextStart(id);
                        self.visit_newline_text_start_terminal(terminal, data, tree)?;
                    }
