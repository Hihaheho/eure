...
use parol_walker::{
    BuiltinTerminalVisitor as PwBuiltinTerminalVisitor, CstConstructError, CstFacade, CstNodeData,
    CstNodeId, NodeKind, NonTerminalData, NonTerminalHandle as _, TerminalData,
    TerminalHandle as _,
};
...
pub trait CstVisitor<F: CstFacade<TerminalKind, NonTerminalKind>>:
    CstVisitorSuper<F, Self::Error>
{
    type Error;
    fn visit_array(
        &mut self,
...
pub trait CstVisitorSuper<F: CstFacade<TerminalKind, NonTerminalKind>, E>:
    private::Sealed<F>
{
    ...
    fn visit_backtick_1_handle(&mut self, handle: Backtick1Handle, tree: &F) -> Result<(), E>;
    ...
    fn visit_inline_code_2_handle(&mut self, handle: InlineCode2Handle, tree: &F) -> Result<(), E>;
...
impl<
    V: CstVisitor<F> + BuiltinTerminalVisitor<V::Error, F>,
    F: CstFacade<TerminalKind, NonTerminalKind>,
> CstVisitorSuper<F, V::Error> for V
{
    fn visit_array_handle(&mut self, handle: ArrayHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_array(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
            Ok(Err(e)) => Err(e),
            Err(e) => adapter.0.then_construct_error(
                Some(CstNode::NonTerminal {
                    kind: handle.kind(),
                    data: nt_data,
                }),
                handle.node_id(),
        ...
        adapter
            .0
            .visit_non_terminal_close(handle.node_id(), handle.kind(), nt_data, tree)?;
        result
    }
    fn visit_array_begin_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_array_begin(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_array_elements_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_array_elements(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_array_elements_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_array_elements_tail_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_array_elements_tail(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_array_elements_tail_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_array_elements_tail_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_array_end_handle(&mut self, handle: ArrayEndHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_array_end(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_array_marker_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_array_marker(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_array_marker_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_array_marker_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_array_opt_handle(&mut self, handle: ArrayOptHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_array_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_at_handle(&mut self, handle: AtHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_at(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_backtick_1_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_backtick_1(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_backtick_2_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_backtick_2(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_backtick_3_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_backtick_3(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_backtick_4_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_backtick_4(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_backtick_5_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_backtick_5(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_begin_handle(&mut self, handle: BeginHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_begin(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_bind_handle(&mut self, handle: BindHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_bind(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_binding_handle(&mut self, handle: BindingHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_binding(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_binding_rhs_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_binding_rhs(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_boolean_handle(&mut self, handle: BooleanHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_boolean(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_3_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_3(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_3_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_code_block_3_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_code_block_3_list_group_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_code_block_3_list_group(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
    ...
    fn visit_code_block_4_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_4(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_4_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_code_block_4_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_code_block_4_list_group_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_code_block_4_list_group(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
    ...
    fn visit_code_block_5_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_5(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_5_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_code_block_5_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_code_block_5_list_group_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_code_block_5_list_group(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
    ...
    fn visit_code_block_6_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_6(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_6_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_code_block_6_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_code_block_6_list_group_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_code_block_6_list_group(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
    ...
    fn visit_code_block_end_3_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_end_3(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_end_4_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_end_4(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_end_5_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_end_5(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_end_6_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_end_6(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_start_3_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_start_3(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_start_4_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_start_4(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_start_5_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_start_5(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_code_block_start_6_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_code_block_start_6(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_comma_handle(&mut self, handle: CommaHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_comma(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_continue_handle(&mut self, handle: ContinueHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_continue(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_dot_handle(&mut self, handle: DotHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_dot(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_end_handle(&mut self, handle: EndHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_end(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_eure_handle(&mut self, handle: EureHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_eure(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_eure_bindings_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_eure_bindings(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_eure_sections_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_eure_sections(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_eure_opt_handle(&mut self, handle: EureOptHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_eure_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_ext_handle(&mut self, handle: ExtHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_ext(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_extension_name_space_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_extension_name_space(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
    ...
    fn visit_false_handle(&mut self, handle: FalseHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_false(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_float_handle(&mut self, handle: FloatHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_float(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_grammar_newline_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_grammar_newline(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_hole_handle(&mut self, handle: HoleHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_hole(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_ident_handle(&mut self, handle: IdentHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_ident(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_inline_code_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_inline_code(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_inline_code_1_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_inline_code_1(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_inline_code_2_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_inline_code_2(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_inline_code_2_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_inline_code_2_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_inline_code_2_list_group_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_inline_code_2_list_group(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
    ...
    fn visit_inline_code_end_2_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_inline_code_end_2(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_inline_code_start_2_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_inline_code_start_2(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_integer_handle(&mut self, handle: IntegerHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_integer(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_key_handle(&mut self, handle: KeyHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_key(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_key_base_handle(&mut self, handle: KeyBaseHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_key_base(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_key_ident_handle(&mut self, handle: KeyIdentHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_key_ident(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_key_opt_handle(&mut self, handle: KeyOptHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_key_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_key_tuple_handle(&mut self, handle: KeyTupleHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_key_tuple(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_key_tuple_elements_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_key_tuple_elements(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_key_tuple_elements_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_key_tuple_elements_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_key_tuple_elements_tail_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    visit.0.visit_key_tuple_elements_tail(handle, view, tree),
                    visit,
                )
            },
            &mut adapter,
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit
                            .0
                            .visit_key_tuple_elements_tail_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_key_tuple_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_key_tuple_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_key_value_handle(&mut self, handle: KeyValueHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_key_value(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_keys_handle(&mut self, handle: KeysHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_keys(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_keys_list_handle(&mut self, handle: KeysListHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_keys_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_l_paren_handle(&mut self, handle: LParenHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_l_paren(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_map_bind_handle(&mut self, handle: MapBindHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_map_bind(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_no_backtick_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_no_backtick(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_no_backtick_inline_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_no_backtick_inline(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_null_handle(&mut self, handle: NullHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_null(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_object_handle(&mut self, handle: ObjectHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_object(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_object_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_object_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_object_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_object_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_object_opt_0_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_object_opt_0(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_object_opt_1_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_object_opt_1(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_r_paren_handle(&mut self, handle: RParenHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_r_paren(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_section_handle(&mut self, handle: SectionHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_section(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_section_binding_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_section_binding(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_section_body_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_section_body(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_section_body_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_section_body_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_section_body_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_section_body_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_str_handle(&mut self, handle: StrHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_str(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_strings_handle(&mut self, handle: StringsHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_strings(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_strings_list_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_strings_list(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_text_handle(&mut self, handle: TextHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_text(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_text_binding_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_text_binding(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_text_binding_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_text_binding_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_text_binding_opt_0_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_text_binding_opt_0(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_text_start_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_text_start(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_true_handle(&mut self, handle: TrueHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_true(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_tuple_handle(&mut self, handle: TupleHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_tuple(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_tuple_elements_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_tuple_elements(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_tuple_elements_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_tuple_elements_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_tuple_elements_tail_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_tuple_elements_tail(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_tuple_elements_tail_opt_handle(
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_tuple_elements_tail_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_tuple_index_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_tuple_index(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_tuple_opt_handle(&mut self, handle: TupleOptHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            ...
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (
                    if let Some(view) = view {
                        visit.0.visit_tuple_opt(handle, view, tree)
                    } else {
                        Ok(())
                    },
                    visit,
    ...
    fn visit_value_handle(&mut self, handle: ValueHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_value(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_value_binding_handle(
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_value_binding(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_ws_handle(&mut self, handle: WsHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_ws(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
    ...
    fn visit_root_handle(&mut self, handle: RootHandle, tree: &F) -> Result<(), V::Error> {
        ...
        let result = match handle.get_view_with_visit(
            tree,
            |view, visit: &mut BuiltinVisitorAdapter<'_, Self>| {
                (visit.0.visit_root(handle, view, tree), visit)
            },
            &mut adapter,
        ) {
            Ok(Ok(())) => Ok(()),
...
impl<V: CstVisitor<F>, F: CstFacade<TerminalKind, NonTerminalKind>>
    BuiltinTerminalVisitor<V::Error, F> for V
{
    fn visit_builtin_whitespace_terminal(
        &mut self,
        node: CstNodeId,
    ...
    for BuiltinVisitorAdapter<'a, V>
{
    fn visit_builtin_whitespace_terminal(
        ...
        self.0
            .visit_whitespace_terminal(Whitespace(node), data, tree)
    }
    fn visit_builtin_new_line_terminal(
        &mut self,
        node: CstNodeId,
    ...
    fn visit_builtin_line_comment_terminal(
        ...
        self.0
            .visit_line_comment_terminal(LineComment(node), data, tree)
    }
    fn visit_builtin_block_comment_terminal(
        &mut self,
        node: CstNodeId,
        ...
        self.0
            .visit_block_comment_terminal(BlockComment(node), data, tree)
    }
}
