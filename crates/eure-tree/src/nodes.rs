...
impl NonTerminalHandle for BacktickDelimHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[backtick_delim], visit_ignored| Ok(
                visit(
                    BacktickDelimView {
...
impl BindingRhsView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct BlockBodyHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for BlockBodyHandle {
    type View = BlockBodyView;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::BlockBody)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
...
impl NonTerminalHandle for DelimCode1Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_start_1, delim_code_1_list, delim_code_end_1], visit_ignored| Ok(
                visit(
                    DelimCode1View {
...
impl NonTerminalHandle for DelimCode1ListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_1_list_group, delim_code_1_list], visit_ignored| Ok(
                visit(
                    Some(DelimCode1ListView {
                        delim_code_1_list_group: DelimCode1ListGroupHandle(
...
impl<F: CstFacade> RecursiveView<F> for DelimCode1ListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { delim_code_1_list_group, .. } = item;
            items.push(delim_code_1_list_group);
            item.delim_code_1_list
                .get_view_with_visit(
                    tree,
                    |view, visit_ignored| {
                        current_view = view;
...
impl NonTerminalHandle for DelimCode2Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_start_2, delim_code_2_list, delim_code_end_2], visit_ignored| Ok(
                visit(
                    DelimCode2View {
...
impl NonTerminalHandle for DelimCode2ListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_2_list_group, delim_code_2_list], visit_ignored| Ok(
                visit(
                    Some(DelimCode2ListView {
                        delim_code_2_list_group: DelimCode2ListGroupHandle(
...
impl<F: CstFacade> RecursiveView<F> for DelimCode2ListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { delim_code_2_list_group, .. } = item;
            items.push(delim_code_2_list_group);
            item.delim_code_2_list
                .get_view_with_visit(
                    tree,
                    |view, visit_ignored| {
                        current_view = view;
...
impl NonTerminalHandle for DelimCode3Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_start_3, delim_code_3_list, delim_code_end_3], visit_ignored| Ok(
                visit(
                    DelimCode3View {
...
impl NonTerminalHandle for DelimCode3ListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_3_list_group, delim_code_3_list], visit_ignored| Ok(
                visit(
                    Some(DelimCode3ListView {
                        delim_code_3_list_group: DelimCode3ListGroupHandle(
...
impl<F: CstFacade> RecursiveView<F> for DelimCode3ListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { delim_code_3_list_group, .. } = item;
            items.push(delim_code_3_list_group);
            item.delim_code_3_list
                .get_view_with_visit(
                    tree,
                    |view, visit_ignored| {
                        current_view = view;
...
impl NonTerminalHandle for DelimCodeEnd1Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_end_1], visit_ignored| Ok(
                visit(
                    DelimCodeEnd1View {
...
impl NonTerminalHandle for DelimCodeEnd2Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_end_2], visit_ignored| Ok(
                visit(
                    DelimCodeEnd2View {
...
impl NonTerminalHandle for DelimCodeEnd3Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_end_3], visit_ignored| Ok(
                visit(
                    DelimCodeEnd3View {
...
impl NonTerminalHandle for DelimCodeStart1Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_start_1], visit_ignored| Ok(
                visit(
                    DelimCodeStart1View {
...
impl NonTerminalHandle for DelimCodeStart2Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_start_2], visit_ignored| Ok(
                visit(
                    DelimCodeStart2View {
...
impl NonTerminalHandle for DelimCodeStart3Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[delim_code_start_3], visit_ignored| Ok(
                visit(
                    DelimCodeStart3View {
...
impl DotView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct DotKeyHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for DotKeyHandle {
    ...
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::DotKey)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
...
impl NonTerminalHandle for EureOptHandle {
    type View = Option<TopLevelBindingHandle>;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        Ok(
            visit(
                    Some(
                        TopLevelBindingHandle::new_with_visit(
                            self.0,
                            tree,
                            visit_ignored,
                        )?,
...
impl FalseView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct FirstKeyHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for FirstKeyHandle {
    ...
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::FirstKey)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::Key) => {
                FirstKeyView::Key(KeyHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::ArrayMarker) => {
                FirstKeyView::ArrayMarker(ArrayMarkerHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
impl FirstKeyView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct FlatBodyHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for FlatBodyHandle {
    type View = FlatBodyView;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::FlatBody)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            self.0,
            [
                NodeKind::NonTerminal(NonTerminalKind::SectionHead),
                NodeKind::NonTerminal(NonTerminalKind::FlatBodyList),
            ],
            |[section_head, flat_body_list], visit_ignored| Ok(
                visit(
                    FlatBodyView {
                        section_head: SectionHeadHandle(section_head),
                        flat_body_list: FlatBodyListHandle(flat_body_list),
                    },
                    visit_ignored,
                ),
            ),
...
impl FlatBodyView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct FlatBodyListHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for FlatBodyListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[binding, flat_body_list], visit_ignored| Ok(
                visit(
                    Some(FlatBodyListView {
                        binding: BindingHandle(binding),
                        flat_body_list: FlatBodyListHandle(flat_body_list),
                    }),
                    visit_ignored,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct FlatRootBindingHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for FlatRootBindingHandle {
    type View = FlatRootBindingView;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::FlatRootBinding)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::ValueBinding) => {
                FlatRootBindingView::ValueBinding(ValueBindingHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::TextBinding) => {
                FlatRootBindingView::TextBinding(TextBindingHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum FlatRootBindingView {
    ValueBinding(ValueBindingHandle),
    TextBinding(TextBindingHandle),
}
impl FlatRootBindingView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl NonTerminalHandle for KeyHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::KeyIdent) => {
                KeyView::KeyIdent(KeyIdentHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::ExtensionNameSpace) => {
                KeyView::ExtensionNameSpace(ExtensionNameSpaceHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::String) => {
                KeyView::String(StringHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::Integer) => {
                KeyView::Integer(IntegerHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::Float) => {
                KeyView::Float(FloatHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::KeyTuple) => {
                KeyView::KeyTuple(KeyTupleHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::TupleIndex) => {
                KeyView::TupleIndex(TupleIndexHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::Hole) => {
                KeyView::Hole(HoleHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
impl KeyIdentView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct KeyTailHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for KeyTailHandle {
    ...
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::KeyTail)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::DotKey) => {
                KeyTailView::DotKey(DotKeyHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::ArrayMarker) => {
                KeyTailView::ArrayMarker(ArrayMarkerHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
impl NonTerminalHandle for KeyValueHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            ...
            NodeKind::NonTerminal(NonTerminalKind::Hole) => {
                KeyValueView::Hole(HoleHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
impl NonTerminalHandle for KeysHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[first_key, keys_list], visit_ignored| Ok(
                visit(
                    KeysView {
                        first_key: FirstKeyHandle(first_key),
...
impl NonTerminalHandle for KeysListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[key_tail, keys_list], visit_ignored| Ok(
                visit(
                    Some(KeysListView {
                        key_tail: KeyTailHandle(key_tail),
                        keys_list: KeysListHandle(keys_list),
                    }),
                    visit_ignored,
                ),
...
impl NonTerminalHandle for LitStr1Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_1_start, lit_str_1_list, lit_str_1_end], visit_ignored| Ok(
                visit(
                    LitStr1View {
...
impl NonTerminalHandle for LitStr1EndHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_1_end], visit_ignored| Ok(
                visit(
                    LitStr1EndView {
...
impl NonTerminalHandle for LitStr1ListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_1_list_group, lit_str_1_list], visit_ignored| Ok(
                visit(
                    Some(LitStr1ListView {
                        lit_str_1_list_group: LitStr1ListGroupHandle(
...
impl<F: CstFacade> RecursiveView<F> for LitStr1ListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { lit_str_1_list_group, .. } = item;
...
impl NonTerminalHandle for LitStr1StartHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_1_start], visit_ignored| Ok(
                visit(
                    LitStr1StartView {
...
impl NonTerminalHandle for LitStr2Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_2_start, lit_str_2_list, lit_str_2_end], visit_ignored| Ok(
                visit(
                    LitStr2View {
...
impl NonTerminalHandle for LitStr2EndHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_2_end], visit_ignored| Ok(
                visit(
                    LitStr2EndView {
...
impl NonTerminalHandle for LitStr2ListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_2_list_group, lit_str_2_list], visit_ignored| Ok(
                visit(
                    Some(LitStr2ListView {
                        lit_str_2_list_group: LitStr2ListGroupHandle(
...
impl<F: CstFacade> RecursiveView<F> for LitStr2ListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { lit_str_2_list_group, .. } = item;
...
impl NonTerminalHandle for LitStr2StartHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_2_start], visit_ignored| Ok(
                visit(
                    LitStr2StartView {
...
impl NonTerminalHandle for LitStr3Handle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_3_start, lit_str_3_list, lit_str_3_end], visit_ignored| Ok(
                visit(
                    LitStr3View {
...
impl NonTerminalHandle for LitStr3EndHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_3_end], visit_ignored| Ok(
                visit(
                    LitStr3EndView {
...
impl NonTerminalHandle for LitStr3ListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_3_list_group, lit_str_3_list], visit_ignored| Ok(
                visit(
                    Some(LitStr3ListView {
                        lit_str_3_list_group: LitStr3ListGroupHandle(
...
impl<F: CstFacade> RecursiveView<F> for LitStr3ListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { lit_str_3_list_group, .. } = item;
...
impl NonTerminalHandle for LitStr3StartHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[lit_str_3_start], visit_ignored| Ok(
                visit(
                    LitStr3StartView {
...
impl NonTerminalHandle for NaNHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[na_n], visit_ignored| Ok(
                visit(NaNView { na_n: NaN(na_n) }, visit_ignored),
            ),
            visit_ignored,
        )
    }
...
impl NaNView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct NewlineBindHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for NewlineBindHandle {
    type View = NewlineBindView;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::NewlineBind)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            self.0,
            [NodeKind::Terminal(TerminalKind::NewlineBind)],
            |[newline_bind], visit_ignored| Ok(
                visit(
                    NewlineBindView {
                        newline_bind: NewlineBind(newline_bind),
                    },
                    visit_ignored,
                ),
            ),
...
impl NewlineBindView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct NewlineHeadHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for NewlineHeadHandle {
    type View = NewlineHeadView;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::NewlineHead)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            [
                NodeKind::NonTerminal(NonTerminalKind::GrammarNewline),
                NodeKind::NonTerminal(NonTerminalKind::NewlineHeadOpt),
            ],
            |[grammar_newline, newline_head_opt], visit_ignored| Ok(
                visit(
                    NewlineHeadView {
                        grammar_newline: GrammarNewlineHandle(grammar_newline),
                        newline_head_opt: NewlineHeadOptHandle(newline_head_opt),
                    },
                    visit_ignored,
                ),
            ),
...
impl NewlineHeadView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct NewlineHeadOptHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for NewlineHeadOptHandle {
    type View = Option<FlatRootBindingHandle>;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        Ok(
            visit(
                    Some(
                        FlatRootBindingHandle::new_with_visit(
                            self.0,
                            tree,
                            visit_ignored,
                        )?,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct NewlineTextStartHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for NewlineTextStartHandle {
    ...
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::NewlineTextStart)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            self.0,
            [NodeKind::Terminal(TerminalKind::NewlineTextStart)],
            |[newline_text_start], visit_ignored| Ok(
                visit(
                    NewlineTextStartView {
                        newline_text_start: NewlineTextStart(newline_text_start),
                    },
                    visit_ignored,
                ),
            ),
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct NewlineTextStartView {
    pub newline_text_start: NewlineTextStart,
}
impl NewlineTextStartView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl NonTerminalHandle for NumberHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::Float) => {
                NumberView::Float(FloatHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::Integer) => {
                NumberView::Integer(IntegerHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::Inf) => {
                NumberView::Inf(InfHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::NaN) => {
                NumberView::NaN(NaNHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
impl NonTerminalHandle for RootBindingHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::RootValueBinding) => {
                RootBindingView::RootValueBinding(RootValueBindingHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::RootTextBinding) => {
                RootBindingView::RootTextBinding(RootTextBindingHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct RootTextBindingHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for RootTextBindingHandle {
    type View = RootTextBindingView;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            [
                NodeKind::NonTerminal(NonTerminalKind::NewlineTextStart),
                NodeKind::NonTerminal(NonTerminalKind::RootTextBindingOpt),
                NodeKind::NonTerminal(NonTerminalKind::RootTextBindingOpt0),
                NodeKind::NonTerminal(NonTerminalKind::RootTextBindingOpt1),
            ],
            |
                [newline_text_start,
            ...
            Ok(
                visit(
                    RootTextBindingView {
                        newline_text_start: NewlineTextStartHandle(newline_text_start),
                        root_text_binding_opt: RootTextBindingOptHandle(
                            root_text_binding_opt,
                        ),
                        root_text_binding_opt_0: RootTextBindingOpt0Handle(
                            root_text_binding_opt_0,
                        ),
                        root_text_binding_opt_1: RootTextBindingOpt1Handle(
                            root_text_binding_opt_1,
                        ),
                    },
                    visit_ignored,
...
impl RootTextBindingView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct RootTextBindingOptHandle(pub(crate) super::tree::CstNodeId);
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct RootTextBindingOpt0Handle(pub(crate) super::tree::CstNodeId);
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct RootTextBindingOpt1Handle(pub(crate) super::tree::CstNodeId);
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct RootValueBindingHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for RootValueBindingHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[newline_bind, value], visit_ignored| Ok(
                visit(
                    RootValueBindingView {
                        newline_bind: NewlineBindHandle(newline_bind),
                        value: ValueHandle(value),
                    },
                    visit_ignored,
                ),
...
impl NonTerminalHandle for SectionBodyHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            ...
            NodeKind::NonTerminal(NonTerminalKind::BlockBody) => {
                SectionBodyView::BlockBody(BlockBodyHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
impl NonTerminalHandle for SectionBodyOptHandle {
    type View = Option<FlatBodyHandle>;
    fn node_id(&self) -> CstNodeId {
        self.0
    }
    fn new_with_visit<F: CstFacade, E>(
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        Ok(
            visit(
                    Some(FlatBodyHandle::new_with_visit(self.0, tree, visit_ignored)?),
                    visit_ignored,
                )
                .0,
        )
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct SectionHeadHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for SectionHeadHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::RootBinding) => {
                SectionHeadView::RootBinding(RootBindingHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::NewlineHead) => {
                SectionHeadView::NewlineHead(NewlineHeadHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SectionHeadView {
    RootBinding(RootBindingHandle),
    NewlineHead(NewlineHeadHandle),
}
impl SectionHeadView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl NonTerminalHandle for StringHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::Str) => {
                StringView::Str(StrHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::LitStr) => {
...
impl NonTerminalHandle for StringsHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[string, strings_list], visit_ignored| Ok(
                visit(
                    StringsView {
...
impl NonTerminalHandle for StringsListHandle {
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        tree.collect_nodes(
            ...
            |[r#continue, string, strings_list], visit_ignored| Ok(
                visit(
...
impl<F: CstFacade> RecursiveView<F> for StringsListView {
    ...
    fn get_all_with_visit<E>(
        ...
        let mut current_view = Some(*self);
        while let Some(item) = current_view {
            let Self { r#continue, string, .. } = item;
            items
                .push(StringsListItem {
                    r#continue,
                    string,
                });
            item.strings_list
...
impl TextStartView {}
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct TopLevelBindingHandle(pub(crate) super::tree::CstNodeId);
impl NonTerminalHandle for TopLevelBindingHandle {
    ...
    fn new_with_visit<F: CstFacade, E>(
        ...
        tree.collect_nodes(
            index,
            [NodeKind::NonTerminal(NonTerminalKind::TopLevelBinding)],
            |[index], visit| Ok((Self(index), visit)),
            visit_ignored,
        )
    }
    ...
    fn get_view_with_visit<'v, F: CstFacade, V: BuiltinTerminalVisitor<E, F>, O, E>(
        ...
        let variant = match child_data.node_kind() {
            NodeKind::NonTerminal(NonTerminalKind::ValueBinding) => {
                TopLevelBindingView::ValueBinding(ValueBindingHandle(child))
            }
            NodeKind::NonTerminal(NonTerminalKind::TextBinding) => {
                TopLevelBindingView::TextBinding(TextBindingHandle(child))
            }
            _ => {
                return Err(ViewConstructionError::UnexpectedNode {
                    node: child,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct NewlineBind(pub(crate) super::tree::CstNodeId);
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct NewlineTextStart(pub(crate) super::tree::CstNodeId);
