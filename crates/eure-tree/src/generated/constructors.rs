...
pub mod constructors {
    ...
    impl ArrayBeginConstructor {
        pub fn build(self) -> ArrayBeginNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::ArrayBegin, vec![l_bracket]);
    ...
    impl ArrayElementsOptConstructor {
        pub fn build(self) -> ArrayElementsOptNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::ArrayElementsOpt, children);
    ...
    impl ArrayEndConstructor {
        pub fn build(self) -> ArrayEndNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::ArrayEnd, vec![r_bracket]);
    ...
    impl ArrayMarkerOptConstructor {
        pub fn build(self) -> ArrayMarkerOptNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::ArrayMarkerOpt, children);
            ArrayMarkerOptNode {
                node_id,
                builder,
            }
    ...
    impl BindingRhsConstructor {
        pub fn build(self) -> BindingRhsNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::BindingRhs, vec![child_id]);
    ...
    impl CodeBlockConstructor {
        pub fn build(self) -> CodeBlockNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::CodeBlock, vec![code_block]);
    ...
    impl KeysConstructor {
        pub fn build(self) -> KeysNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::Keys, vec![key, keys_list]);
    ...
    impl NamedCodeConstructor {
        pub fn build(self) -> NamedCodeNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::NamedCode, vec![named_code]);
    ...
    impl SectionBodyConstructor {
        pub fn build(self) -> SectionBodyNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::SectionBody, vec![child_id]);
            SectionBodyNode {
                node_id,
                builder,
            }
    ...
    impl TextBindingOptConstructor {
        pub fn build(self) -> TextBindingOptNode {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::TextBindingOpt, children);
            TextBindingOptNode {
                node_id,
                builder,
            }
    ...
    impl TextBindingOpt0Constructor {
        pub fn build(self) -> TextBindingOpt0Node {
            ...
            let node_id = builder
                .non_terminal(NonTerminalKind::TextBindingOpt0, children);
            TextBindingOpt0Node {
                node_id,
                builder,
            }
    ...
    impl TextStartConstructor {
        pub fn build(self) -> TextStartNode {
            ...
            let text_start = builder.embed(self.text_start.builder);
            let node_id = builder
                .non_terminal(NonTerminalKind::TextStart, vec![text_start]);
