...
fn generate_node_kind(path: &str) {
    ...
    let node_kind_enum: syn::File = parse_quote! {
    ...
    // Combine header + existing content + new enum
    let node_kind_str = prettyplease::unparse(&node_kind_enum);
    let final_content = format!("{}{}\n{}", header_str, existing_content, node_kind_str);
