...
#[derive(Debug, Clone, PartialEq, Default)]
/// How to represent code in a data model. Corresponds to the `$code-repr` extension.
pub enum CodeRepr {
    /// Markdown string. e.g. "```rust\nfn main() { println!(\"Hello, world!\"); }\n```".
    Markdown,
    /// Content only string. e.g. "fn main() { println!(\"Hello, world!\"); }".
    String,
    /// Object with language and content fields. e.g. `{"language": "rust", "content": "fn main() { println!(\"Hello, world!\"); }"}`.
    Object {
        language_key: String,
        content_key: String,
    },
