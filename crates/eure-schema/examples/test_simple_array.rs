...
"#;
    ...
    let extracted1 = extract_schema_from_value(schema1).expect("Failed to extract schema").document_schema;
...
"#;
    ...
    let extracted2 = extract_schema_from_value(schema2).expect("Failed to extract schema").document_schema;
