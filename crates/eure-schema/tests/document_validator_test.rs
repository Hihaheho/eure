...
use eure_schema::{
    Constraints, DocumentSchema, FieldSchema, ObjectSchema, Type, ValidationErrorKind, VariantRepr,
    VariantSchema, document_to_schema, validate_document,
};
...
"#;
    ...
    assert_eq!(
        errors.len(),
        0,
        "Document should be valid against extracted schema"
    );
}
