...
Most of this repository is licensed under either of:
...
- `crates/eure-mark/**` is licensed under MPL-2.0. See [crates/eure-mark/README.md](crates/eure-mark/README.md) and [crates/eure-mark/LICENSE](crates/eure-mark/LICENSE).

### Contribution

Unless you explicitly state otherwise, any contribution intentionally submitted for inclusion in the work by you, as defined in the Apache-2.0 license, shall be licensed as follows, without any additional terms or conditions:

- Contributions outside `crates/eure-mark/**`: dual licensed under Apache-2.0 or MIT, as above.
- Contributions to `crates/eure-mark/**`: licensed under MPL-2.0.
